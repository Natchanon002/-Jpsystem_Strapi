...
var FIELD_SCHEMA = create4().shape({
  ...
  description: create2().nullable(),
  placeholder: create2().nullable(),
  editable: create(),
      ...
      children: [
        (0, import_jsx_runtime.jsx)(n1.Header, {
          children: (0, import_jsx_runtime.jsxs)(T, {
            ...
            children: [
              ...
              (0, import_jsx_runtime.jsx)(n1.Title, {
        ...
        (0, import_jsx_runtime.jsx)(n1.Body, {
          children: (0, import_jsx_runtime.jsx)(Um.Root, {
            ...
            ].filter(filterFieldsBasedOnAttributeType(attribute.type)).map(({ size, ...field }) => (0, import_jsx_runtime.jsx)(Um.Item, {
              col: size,
              xs: 12,
              direction: "column",
              alignItems: "stretch",
  ...
  return (0, import_jsx_runtime2.jsx)(DndContext, {
    ...
    onDragOver: ({ active, over }) => {
      ...
      const update = fn(containers, (draft) => {
        ...
        const isHoveringOverSpacer = (overItem == null ? void 0 : overItem.name) === TEMP_FIELD_NAME;
        if (isNotEnoughSpace) {
            ...
            children: [
              containers.map((container, containerIndex) => (0, import_jsx_runtime2.jsx)(SortableContext, {
                ...
                children: (0, import_jsx_runtime2.jsx)(DroppableContainer, {
                  id: container.dndId,
                  children: ({ setNodeRef }) => (0, import_jsx_runtime2.jsx)(Um.Root, {
                    ref: setNodeRef,
                    gap: 2,
                    children: container.children.map((child, childIndex) => (0, import_jsx_runtime2.jsx)(Um.Item, {
                      col: child.size,
                      xs: 12,
                      direction: "column",
                      alignItems: "stretch",
              ...
              (0, import_jsx_runtime2.jsxs)(Am.Root, {
                children: [
                  (0, import_jsx_runtime2.jsx)(Am.Trigger, {
                  ...
                  (0, import_jsx_runtime2.jsx)(Am.Content, {
                    children: remainingFields.map((field) => (0, import_jsx_runtime2.jsx)(Am.Item, {
...
var Field = ({ attribute, components, name, onRemoveField, dndId }) => {
  ...
  return (0, import_jsx_runtime2.jsxs)(n1.Root, {
    open: isModalOpen,
    ...
    children: [
      (0, import_jsx_runtime2.jsxs)(T, {
        ...
        position: "relative",
        children: [
          isDesktop && (0, import_jsx_runtime2.jsx)(DragButton, {
          ...
          (0, import_jsx_runtime2.jsxs)(T, {
            ...
            children: [
                  ...
                  (0, import_jsx_runtime2.jsxs)(T, {
                    ...
                    children: [
                      ...
                      (0, import_jsx_runtime2.jsx)(st, {
                        ...
                        children: (0, import_jsx_runtime2.jsx)(C5, {})
                      })
                    ]
                  })
                ]
              }),
              (attribute == null ? void 0 : attribute.type) === "component" ? (0, import_jsx_runtime2.jsxs)(T, {
                paddingTop: 3,
                paddingRight: 3,
                paddingBottom: 3,
                paddingLeft: 0,
                ...
                children: [
                  (0, import_jsx_runtime2.jsx)(Um.Root, {
                    gap: 4,
                    width: "100%",
                    children: components[attribute.component].layout.map((row) => row.map(({ size, ...field }) => (0, import_jsx_runtime2.jsx)(Um.Item, {
                      col: size,
                      xs: 12,
                      direction: "column",
                      alignItems: "stretch",
                  ...
                  (0, import_jsx_runtime2.jsx)(Vc, {
                    ...
                    startIcon: (0, import_jsx_runtime2.jsx)(u5, {}),
                    tag: NavLink,
              ...
              (attribute == null ? void 0 : attribute.type) === "dynamiczone" ? (0, import_jsx_runtime2.jsx)(T, {
                paddingTop: 3,
                paddingRight: 3,
                paddingBottom: 3,
                paddingLeft: 0,
...
var ConfigurationForm = ({ attributes, fieldSizes, layout: editLayout, onSubmit }) => {
  ...
  return (0, import_jsx_runtime3.jsx)(import_jsx_runtime3.Fragment, {
    children: (0, import_jsx_runtime3.jsx)(t1, {
          ...
          (0, import_jsx_runtime3.jsx)(Layouts.Content, {
            children: (0, import_jsx_runtime3.jsxs)(T, {
              ...
              children: [
                ...
                (0, import_jsx_runtime3.jsxs)(Um.Root, {
                  gap: 4,
                  children: [
                    ...
                    (0, import_jsx_runtime3.jsx)(Um.Item, {
                      ...
                      children: (0, import_jsx_runtime3.jsx)(MemoizedInputRenderer, {
                        ...
                        hint: formatMessage({
                          id: getTranslation("containers.SettingPage.editSettings.relationOpenMode.description"),
                        ...
                        options: [
                          {
                            label: formatMessage({
                              id: getTranslation("containers.SettingPage.editSettings.relationOpenMode.modal"),
                          ...
                          {
                            label: formatMessage({
                              id: getTranslation("containers.SettingPage.editSettings.relationOpenMode.page"),
                          ...
                          {
                            label: formatMessage({
                              id: getTranslation("containers.SettingPage.editSettings.relationOpenMode.newTab"),
                ...
                (0, import_jsx_runtime3.jsxs)(T, {
                  ...
                  children: [
                    ...
                    (0, import_jsx_runtime3.jsx)(Fields, {
                      attributes,
                      components,
                      fieldSizes,
                      metadatas
...
var Header = ({ name }) => {
  ...
  return (0, import_jsx_runtime3.jsx)(Layouts.Header, {
    ...
    primaryAction: (0, import_jsx_runtime3.jsx)(zn, {
      disabled: !modified,
...
//# sourceMappingURL=chunk-Q7BZTYQG.js.map
