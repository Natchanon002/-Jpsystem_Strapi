...
function __variableDynamicImportRuntime1__(path) {
  switch (path) {
    case "./translations/cs.json":
      return import("./cs.json-PF7OQ2QZ.js");
    case "./translations/en.json":
      return import("./en.json-625ZJT4D.js");
    case "./translations/es.json":
      return import("./es.json-FBO64WHF.js");
    case "./translations/fr.json":
      return import("./fr.json-IZXNZZJM.js");
    case "./translations/it.json":
      return import("./it.json-CJJP65PI.js");
    case "./translations/nl.json":
      return import("./nl.json-TNYY2BWJ.js");
    case "./translations/ru.json":
      return import("./ru.json-7K6T474R.js");
    case "./translations/tr.json":
      return import("./tr.json-XJI3F3KH.js");
    case "./translations/uk.json":
      return import("./uk.json-OGB7XNQ6.js");
    default:
  ...
  register(app) {
    ...
    if (backendURL == null ? void 0 : backendURL.includes("localhost")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-CFC2KBKY.js").then((mod) => ({
          default: mod.App
        })),
        permissions: []
      });
