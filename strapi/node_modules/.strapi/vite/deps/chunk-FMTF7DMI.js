...
var BalloonImage = gt.img`
  // Margin top|right reverse the padding of ModalBody
  margin-right: ${({ theme }) => `-${theme.spaces[7]}`};
  margin-top: ${({ theme }) => `-${theme.spaces[7]}`};
  width: 360px;
`;
var Root = ({ children, open = false, onOpenChange }) => {
  const { formatMessage } = useIntl();
  return (0, import_jsx_runtime.jsx)(n1.Root, {
    open,
    onOpenChange,
    children: (0, import_jsx_runtime.jsx)(n1.Content, {
      children: (0, import_jsx_runtime.jsx)(n1.Body, {
        children: (0, import_jsx_runtime.jsxs)(T, {
          ...
          children: [
            ...
            (0, import_jsx_runtime.jsxs)(T, {
              ...
              width: "40%",
              children: [
                (0, import_jsx_runtime.jsx)(BalloonImage, {
                  src: img,
                  "aria-hidden": true,
                  alt: "",
                  loading: "lazy"
                ...
                (0, import_jsx_runtime.jsx)(R, {
                  ...
                  right: 0,
                  top: 0,
                  children: (0, import_jsx_runtime.jsx)(n1.Close, {
...
// node_modules/@strapi/review-workflows/dist/admin/services/settings.mjs
var settingsApi = reviewWorkflowsApi.injectEndpoints({
  endpoints: (builder) => ({
    getWorkflows: builder.query({
      ...
      providesTags: (res) => {
        return [
          ...(res == null ? void 0 : res.workflows.map(({ id }) => ({
            type: "ReviewWorkflow",
            id
          }))) ?? [],
          {
...
var { useGetWorkflowsQuery, useCreateWorkflowMutation, useDeleteWorkflowMutation, useUpdateWorkflowMutation } = settingsApi;
...
//# sourceMappingURL=chunk-FMTF7DMI.js.map
