...
// node_modules/@strapi/admin/dist/admin/admin/src/hooks/useWarnIfUnsavedChanges.mjs
...
var Form = React.forwardRef(({ disabled = false, method, onSubmit, initialErrors, ...props }, ref) => {
  ...
  const validate = React.useCallback(async (shouldSetErrors = true, options = {}) => {
    ...
    if (!props.validationSchema && !props.validate) {
      return {
        data: valuesToValidate
      };
    }
    try {
      let data;
      if (props.validationSchema) {
        data = await props.validationSchema.validate(valuesToValidate, {
          abortEarly: false
        });
  ...
  const handleChange = Io((eventOrPath, v) => {
  ...
  const composedRefs = Ce(formRef, ref);
      ...
      children: (0, import_jsx_runtime.jsxs)(_m.Content, {
        children: [
          ...
          (0, import_jsx_runtime.jsx)(_m.Body, {
            icon: (0, import_jsx_runtime.jsx)(Nn, {
              width: "24px",
              height: "24px",
              fill: "danger600"
            }),
...
//# sourceMappingURL=chunk-WR4W2XSF.js.map
