import {
  PrivateRoute
} from "./chunk-DTY74EHO.js";
import {
  NpsSurvey
} from "./chunk-HSHFMGB2.js";
import {
  HTML5Backend
    ...
    var SemVer = class _SemVer {
      constructor(version, options) {
        ...
        if (!m2[4]) {
          ...
          this.prerelease = m2[4].split(".").map((id3) => {
            if (/^[0-9]+$/.test(id3)) {
              const num = +id3;
...
// node_modules/@strapi/admin/dist/admin/admin/src/components/MainNav/MainNavLinks.mjs
...
var isExternalLink = (to) => typeof to === "string" && (to.startsWith("http://") || to.startsWith("https://"));
var MainNavLinkStyles = ft`
...
`;
var MainNavLinkWrapper = gt(NavLink)`
  ${MainNavLinkStyles}
`;
var MainNavLinkAnchor = gt.a`
  ${MainNavLinkStyles}
`;
var MainNavButtonStyles = ft`
  padding-block: 1rem;
  padding-inline: 1rem;
`;
var MainNavButtonWrapper = gt(MainNavLinkWrapper)`
  ${MainNavButtonStyles}
`;
var MainNavButtonAnchor = gt(MainNavLinkAnchor)`
  ${MainNavButtonStyles}
`;
var LinkImpl = ({ children, to, ...props }) => {
  if (isExternalLink(to)) {
    return (0, import_jsx_runtime2.jsx)(MainNavLinkAnchor, {
      href: to,
      ...props,
      children
    });
  }
  return (0, import_jsx_runtime2.jsx)(MainNavLinkWrapper, {
    to,
    ...props,
    children
  });
};
var NavButtonImpl = ({ children, to, ...props }) => {
  if (isExternalLink(to)) {
    return (0, import_jsx_runtime2.jsx)(MainNavButtonAnchor, {
      href: to,
      ...props,
      children
    });
  }
  return (0, import_jsx_runtime2.jsx)(MainNavButtonWrapper, {
    to,
    ...props,
    children
  });
};
var TooltipImpl = ({ children, label, position = "right" }) => {
  return (0, import_jsx_runtime2.jsx)(Tr, {
    side: position,
    label,
    delayDuration: 0,
...
var IconImpl = ({ label, children }) => {
  ...
  return (0, import_jsx_runtime2.jsx)(zt, {
    label,
    children
  });
};
var CustomBadge = gt(Ls)`
...
var BadgeImpl = ({ children, label, ...props }) => {
  ...
  return (0, import_jsx_runtime2.jsx)(CustomBadge, {
    position: "absolute",
    top: "-0.8rem",
    left: "1.7rem",
    "aria-label": label,
...
// node_modules/@strapi/admin/dist/admin/admin/src/components/MainNav/MainNavLinks.mjs
var NavLinkBadgeLock = gt(NavLink2.Badge)`
  background-color: transparent;
`;
var NavLinkBadgeCounter = gt(NavLink2.Badge)`
  span {
...
var GuidedTourTooltip = ({ to, children }) => {
  ...
  switch (normalizedTo) {
    case "content-manager":
      return (0, import_jsx_runtime3.jsx)(tours.contentTypeBuilder.Finish, {
        children
      });
    case "":
      return (0, import_jsx_runtime3.jsx)(tours.apiTokens.Finish, {
        children
      });
    case "settings":
      return (0, import_jsx_runtime3.jsx)(tours.contentManager.Finish, {
        children
      });
    default:
      return children;
...
var MainNavIcons = ({ listLinks, mobileLinks, handleClickOnLink }) => {
  const { formatMessage } = useIntl();
  const isDesktop = useIsDesktop();
  return listLinks.length > 0 ? listLinks.map((link) => {
    const LinkIcon = link.icon;
    const badgeContentLock = (link == null ? void 0 : link.licenseOnly) ? (0, import_jsx_runtime3.jsx)(C3, {
      fill: "primary600"
    }) : void 0;
    ...
    const LinkElement = () => (0, import_jsx_runtime3.jsxs)(NavLink2.NavButton, {
      to: link.to,
      target: link.target,
      onClick: () => handleClickOnLink(link.to),
      "aria-label": labelValue,
      children: [
        (0, import_jsx_runtime3.jsx)(NavLink2.Icon, {
          label: labelValue,
          children: (0, import_jsx_runtime3.jsx)(LinkIcon, {
            width: "20",
            height: "20",
            fill: "neutral500"
          })
        }),
        badgeContentLock ? (0, import_jsx_runtime3.jsx)(NavLinkBadgeLock, {
          label: "locked",
          textColor: "neutral500",
          paddingLeft: 0,
          paddingRight: 0,
          children: badgeContentLock
        }) : badgeContentNumeric ? (0, import_jsx_runtime3.jsx)(NavLinkBadgeCounter, {
    ...
    return isDesktop || !isDesktop && linkMobile ? (0, import_jsx_runtime3.jsx)(T, {
      tag: "li",
      children: (0, import_jsx_runtime3.jsx)(GuidedTourTooltip, {
        to: link.to,
        children: (0, import_jsx_runtime3.jsx)(NavLink2.Tooltip, {
          position: isDesktop ? "right" : "bottom",
          label: labelValue,
          children: (0, import_jsx_runtime3.jsx)(LinkElement, {})
        })
      })
    }, link.to) : null;
  }) : null;
};
var IconContainer = gt(R)`
  svg {
    display: block;
  }
`;
var MainNavBurgerMenuLinks = ({ listLinks, handleClickOnLink }) => {
  const { formatMessage } = useIntl();
  return listLinks.length > 0 ? listLinks.map((link) => {
    const LinkIcon = link.icon;
    const badgeContentLock = (link == null ? void 0 : link.licenseOnly) ? (0, import_jsx_runtime3.jsx)(C3, {
    ...
    return (0, import_jsx_runtime3.jsx)(T, {
      alignItems: "center",
      tag: "li",
      children: (0, import_jsx_runtime3.jsx)(NavLink2.Link, {
        to: navigationTarget,
        onClick: () => handleClickOnLink(navigationTarget),
        "aria-label": labelValue,
        children: (0, import_jsx_runtime3.jsxs)(T, {
          alignItems: "center",
          gap: 3,
          children: [
            (0, import_jsx_runtime3.jsx)(IconContainer, {
              children: (0, import_jsx_runtime3.jsx)(LinkIcon, {
                width: "20",
                height: "20",
                fill: "neutral500"
...
var NavBrand = () => {
  ...
  return (0, import_jsx_runtime4.jsx)(T, {
    alignItems: "center",
    padding: 3,
    children: (0, import_jsx_runtime4.jsx)(R, {
      padding: {
        initial: 1,
        medium: 0
      },
      children: (0, import_jsx_runtime4.jsxs)(BrandIconWrapper, {
        direction: "column",
        justifyContent: "center",
        width: "3.2rem",
        height: "3.2rem",
        children: [
          (0, import_jsx_runtime4.jsx)("img", {
...
// node_modules/@strapi/admin/dist/admin/admin/src/components/MainNav/NavBurgerMenu.mjs
...
function PopChild({ children, isPresent, anchorX, anchorY, root, pop }) {
  ...
  return (0, import_jsx_runtime5.jsx)(PopChildMeasure, { isPresent, childRef: ref, sizeRef: size, pop, children: pop === false ? children : React2.cloneElement(children, { ref: composedRef }) });
}
...
var PresenceChild = ({ children, initial, isPresent, onExitComplete, custom, presenceAffectsLayout, mode, anchorX, anchorY, root }) => {
  ...
  children = (0, import_jsx_runtime6.jsx)(PopChild, { pop: mode === "popLayout", isPresent, anchorX, anchorY, root, children });
...
var AnimatePresence = ({ children, custom, initial = true, onExitComplete, presenceAffectsLayout = true, mode = "sync", propagate = false, anchorX = "left", anchorY = "top", root }) => {
  ...
  return (0, import_jsx_runtime7.jsx)(import_jsx_runtime7.Fragment, { children: renderedChildren.map((child) => {
    ...
    return (0, import_jsx_runtime7.jsx)(PresenceChild, { isPresent, initial: !isInitialRender.current || initial ? void 0 : false, custom, presenceAffectsLayout, mode, root, onExitComplete: isPresent ? void 0 : onExit, anchorX, anchorY, children: child }, key);
  }) });
};
...
var DeprecatedLayoutGroupContext = (0, import_react13.createContext)(null);
...
var MotionContext = (0, import_react20.createContext)({});
...
function useCreateMotionContext(props) {
  const { initial, animate: animate2 } = getCurrentTreeVariants(props, (0, import_react21.useContext)(MotionContext));
  return (0, import_react21.useMemo)(() => ({ initial, animate: animate2 }), [variantLabelsAsDependency(initial), variantLabelsAsDependency(animate2)]);
}
...
function useVisualElement(Component3, visualState, props, createVisualElement, ProjectionNodeConstructor, isSVG) {
  ...
  const wantsHandoff = (0, import_react28.useRef)(Boolean(optimisedAppearId) && typeof window !== "undefined" && !((_a = window.MotionHandoffIsComplete) == null ? void 0 : _a.call(window, optimisedAppearId)) && ((_b = window.MotionHasOptimisedAnimation) == null ? void 0 : _b.call(window, optimisedAppearId)));
  useIsomorphicLayoutEffect(() => {
...
function createMotionComponent(Component3, { forwardMotionProps = false, type } = {}, preloadedFeatures, createVisualElement) {
  ...
  function MotionDOMComponent(props, externalRef) {
    ...
    return (0, import_jsx_runtime11.jsxs)(MotionContext.Provider, { value: context, children: [MeasureLayout2 && context.visualElement ? (0, import_jsx_runtime11.jsx)(MeasureLayout2, { visualElement: context.visualElement, ...configAndProps }) : null, useRender(Component3, props, useMotionRef(visualState, context.visualElement, externalRef), visualState, isStatic, forwardMotionProps, isSVG)] });
  }
...
function MeasureLayout(props) {
  ...
  return (0, import_jsx_runtime12.jsx)(MeasureLayoutWithContext, { ...props, layoutGroup, switchLayoutGroup: (0, import_react31.useContext)(SwitchLayoutGroupContext), isPresent, safeToRemove });
}
...
var ReorderContext = (0, import_react50.createContext)(null);
...
function ReorderGroupComponent({ children, as = "ul", axis = "y", onReorder, values, ...props }, externalRef) {
  ...
  const order = [];
  const isReordering = (0, import_react51.useRef)(false);
  ...
  return (0, import_jsx_runtime14.jsx)(Component3, { ...props, style: groupStyle, ref: setRef2, ignoreStrict: true, children: (0, import_jsx_runtime14.jsx)(ReorderContext.Provider, { value: context, children }) });
}
var ReorderGroup = (0, import_react51.forwardRef)(ReorderGroupComponent);
...
var ReorderItem = (0, import_react52.forwardRef)(ReorderItemComponent);

// node_modules/@strapi/admin/dist/admin/admin/src/components/MainNav/NavUser.mjs
var import_jsx_runtime16 = __toESM(require_jsx_runtime(), 1);
var MenuTrigger = gt(Am.Trigger)`
  padding: 0;
...
var BadgeWrapper = gt(T)`
  ...
  width: 100%;
`;
var StyledTypography = gt(I)`
  word-break: break-word;
  margin-bottom: ${({ theme }) => theme.spaces[3]};
`;
var NavUser = ({ initials, showDisplayName = false, children, ...props }) => {
  var _a;
  const { formatMessage } = useIntl();
  ...
  return (0, import_jsx_runtime16.jsx)(T, {
    ...props,
    children: (0, import_jsx_runtime16.jsxs)(Am.Root, {
      children: [
        (0, import_jsx_runtime16.jsx)(MenuTrigger, {
          endIcon: null,
          fullWidth: true,
          ...
          children: (0, import_jsx_runtime16.jsxs)(T, {
            ...
            gap: 3,
            children: [
              (0, import_jsx_runtime16.jsx)(MenuIcon, {
                justifyContent: "center",
                children: (0, import_jsx_runtime16.jsx)(km.Item, {
                  delayMs: 0,
                  fallback: initials || getInitials(user)
                })
              }),
              showDisplayName ? (0, import_jsx_runtime16.jsx)(I, {
                variant: "omega",
                children: children || userDisplayName
              }) : (0, import_jsx_runtime16.jsx)(at, {
                tag: "span",
                children: children || userDisplayName
              })
            ]
        ...
        (0, import_jsx_runtime16.jsxs)(MenuContent, {
          popoverPlacement: "top-start",
          zIndex: 3,
          children: [
            (0, import_jsx_runtime16.jsxs)(UserInfo, {
              direction: "column",
              gap: 0,
              ...
              children: [
                ...
                (0, import_jsx_runtime16.jsx)(StyledTypography, {
                  variant: "pi",
                  textColor: "neutral600",
                  children: user == null ? void 0 : user.email
                }),
                (0, import_jsx_runtime16.jsx)(BadgeWrapper, {
                  children: (_a = user == null ? void 0 : user.roles) == null ? void 0 : _a.map((role) => (0, import_jsx_runtime16.jsx)(Ls, {
                    children: role.name
                  }, role.id))
                })
              ]
            }),
            (0, import_jsx_runtime16.jsx)(Am.Separator, {}),
            (0, import_jsx_runtime16.jsx)(Am.Item, {
...
`;
var NavBurgerMenu = ({ isShown, handleClickOnLink, onClose, listLinks }) => {
  return (0, import_jsx_runtime17.jsx)(al, {
    children: (0, import_jsx_runtime17.jsx)(AnimatePresence, {
      children: isShown && (0, import_jsx_runtime17.jsx)(P1, {
        onEscape: onClose,
        children: (0, import_jsx_runtime17.jsx)(MotionLayer, {
          role: "dialog",
          "aria-modal": "true",
          initial: {
            y: "-100%"
          ...
          id: "burger-menu",
          children: (0, import_jsx_runtime17.jsx)(Surface, {
            children: (0, import_jsx_runtime17.jsx)(hn, {
              children: (0, import_jsx_runtime17.jsxs)(T, {
                ...
                gap: 3,
                children: [
                  (0, import_jsx_runtime17.jsx)(MainNavBurgerMenuLinks, {
                    listLinks,
                    handleClickOnLink
                  }),
                  (0, import_jsx_runtime17.jsx)(R, {
                    tag: "li",
                    children: (0, import_jsx_runtime17.jsx)(yl, {})
                  }),
                  (0, import_jsx_runtime17.jsx)(R, {
                    paddingLeft: 2,
                    paddingRight: 2,
                    ...
                    paddingBottom: 1,
                    tag: "li",
                    children: (0, import_jsx_runtime17.jsx)(NavUser, {
...
var CircleProgressBar = ({ percentage }) => {
  ...
  return (0, import_jsx_runtime18.jsxs)("svg", {
    ...
    viewBox: "0 0 100 100",
    children: [
      (0, import_jsx_runtime18.jsx)("defs", {
        children: (0, import_jsx_runtime18.jsxs)("linearGradient", {
          id: "progressGradient",
          x1: "0%",
          y1: "0%",
          x2: "100%",
          y2: "0%",
          children: [
            (0, import_jsx_runtime18.jsx)("stop", {
              offset: "0%",
...
var TrialCountdown = () => {
  ...
  const timeDifference = targetDate.getTime() - now2.getTime();
  const daysLeft = Math.ceil(timeDifference / millisecondsPerDay) <= 0 ? 0 : Math.ceil(timeDifference / millisecondsPerDay);
  return (0, import_jsx_runtime18.jsx)(Container, {
    justifyContent: "center",
    padding: 3,
    children: (0, import_jsx_runtime18.jsx)(Tr, {
      ...
      children: (0, import_jsx_runtime18.jsx)("div", {
        ...
        children: (0, import_jsx_runtime18.jsx)(CircleProgressBar, {
...
`;
var LeftMenu = ({ generalSectionLinks, pluginsSectionLinks, topMobileNavigation, burgerMobileNavigation }) => {
  const [isBurgerMenuShown, setIsBurgerMenuShown] = React5.useState(false);
  ...
  return (0, import_jsx_runtime19.jsxs)(import_jsx_runtime19.Fragment, {
    children: [
      (0, import_jsx_runtime19.jsxs)(MainNav, {
        children: [
          (0, import_jsx_runtime19.jsx)(NavBrand, {}),
          isDesktop && (0, import_jsx_runtime19.jsx)(yl, {}),
          (0, import_jsx_runtime19.jsxs)(MenuDetails, {
            children: [
              (0, import_jsx_runtime19.jsx)(NavListWrapper, {
                tag: "ul",
                gap: 3,
                direction: {
                  initial: "row",
                ...
                paddingTop: 3,
                paddingBottom: 3,
                children: (0, import_jsx_runtime19.jsx)(MainNavIcons, {
                  listLinks,
                  mobileLinks: topMobileNavigationLinks,
                  handleClickOnLink
                })
              }),
              (0, import_jsx_runtime19.jsx)(TrialCountdown, {}),
              (0, import_jsx_runtime19.jsx)(R, {
                display: {
                  initial: "none",
                  large: "flex"
                },
                ...
                padding: 3,
                children: (0, import_jsx_runtime19.jsx)(NavUser, {})
              })
            ]
          }),
          (0, import_jsx_runtime19.jsx)(R, {
            ...
            children: (0, import_jsx_runtime19.jsx)(st2, {
              ...
              children: !isBurgerMenuShown ? (0, import_jsx_runtime19.jsx)(A3, {
                fill: "neutral1000"
              }) : (0, import_jsx_runtime19.jsx)(C5, {
                fill: "neutral1000"
              })
            })
          })
      ...
      (0, import_jsx_runtime19.jsx)(NavBurgerMenu, {
...
var PluginsInitializer = ({ children }) => {
  ...
  const [{ plugins }, dispatch] = React6.useReducer(reducer, initialState, () => init(appPlugins));
  const setPlugin = React6.useRef((pluginId) => {
    dispatch({
  ...
  if (hasApluginNotReady) {
    const initializers = Object.keys(plugins).reduce((acc, current) => {
      ...
      if (InitializerComponent) {
        ...
        acc.push((0, import_jsx_runtime20.jsx)(InitializerComponent, {
          setPlugin: setPlugin.current
        }, key));
      }
      return acc;
    }, []);
    return (0, import_jsx_runtime20.jsxs)(import_jsx_runtime20.Fragment, {
      children: [
        initializers,
        (0, import_jsx_runtime20.jsx)(Page.Loading, {})
      ]
    });
  }
  return children;
...
var FixedButtonWrapper = gt(R)`
  ...
  right: 16px;
`;
var Banner = ({ isTrialEndedRecently, onDismiss }) => {
  const { formatMessage } = useIntl();
  return (0, import_jsx_runtime21.jsxs)(import_jsx_runtime21.Fragment, {
    children: [
      (0, import_jsx_runtime21.jsx)(BannerBackground, {
        width: "100%",
        justifyContent: "center",
        children: (0, import_jsx_runtime21.jsxs)(T, {
          justifyContent: "center",
          alignItems: "center",
          width: "100%",
          paddingTop: 2,
          ...
          gap: 2,
          children: [
            (0, import_jsx_runtime21.jsxs)(R, {
              children: [
                (0, import_jsx_runtime21.jsx)(I, {
                  variant: "delta",
                  fontWeight: "bold",
                  textColor: "neutral0",
                  textAlign: "center",
            ...
            (0, import_jsx_runtime21.jsx)(R, {
              children: (0, import_jsx_runtime21.jsx)(e1, {
                width: "max-content",
                variant: "tertiary",
      ...
      (0, import_jsx_runtime21.jsx)(FixedButtonWrapper, {
        children: (0, import_jsx_runtime21.jsx)(st2, {
          withTooltip: false,
          label: formatMessage({
          ...
          onClick: onDismiss,
          children: (0, import_jsx_runtime21.jsx)(C5, {})
        })
      })
    ]
  });
...
var UpsellBanner = () => {
  ...
  const [dismissedFor, setDismissedFor] = useScopedPersistentState("STRAPI_UPSELL_BANNER_DISMISSED_FOR", void 0);
  ...
  const trialEndsAt = ((_b = timeLeftData.data) == null ? void 0 : _b.trialEndsAt) ?? cachedTrialEndsAt;
  const toCanonicalISO = (v) => {
    if (!v) return void 0;
    const date = new Date(v);
    return isValid(date) ? date.toISOString() : void 0;
  };
  ...
  const handleReopen = () => setDismissedFor(void 0);
  if (!(((_c = timeLeftData.data) == null ? void 0 : _c.trialEndsAt) || isTrialEndedRecently)) {
    return null;
  }
  if (isDismissed) {
    return (0, import_jsx_runtime21.jsx)(FixedButtonWrapper, {
      children: (0, import_jsx_runtime21.jsx)(st2, {
        withTooltip: false,
        label: formatMessage({
        ...
        children: (0, import_jsx_runtime21.jsx)(G2, {})
      })
    });
  }
  return (0, import_jsx_runtime21.jsx)(Banner, {
...
var useMenu = (shouldUpdateStrapi) => {
  ...
  const [menuWithUserPermissions, setMenuWithUserPermissions] = React7.useState({
    generalSectionLinks: [
      {
        icon: i3,
        intlLabel: {
  ...
  const generalSectionLinksRef = React7.useRef(menuWithUserPermissions.generalSectionLinks);
  React7.useEffect(() => {
...
var AdminLayout = () => {
  ...
  const [userId, setUserId] = React8.useState();
  ...
  const [tagName, setTagName] = React8.useState(strapiVersion);
  React8.useEffect(() => {
  ...
  React8.useEffect(() => {
    hashAdminUserEmail(userInfo).then((id3) => {
      if (id3) {
        setUserId(id3);
      }
    });
  ...
  if (isLoadingMenu || isLoadingAppInfo) {
    return (0, import_jsx_runtime22.jsx)(Page.Loading, {});
  }
  return (0, import_jsx_runtime22.jsxs)(AppInfoProvider, {
    ...appInfo,
    userId,
    latestStrapiReleaseTag: tagName,
    shouldUpdateStrapi: checkLatestStrapiVersion(strapiVersion, tagName),
    children: [
      (0, import_jsx_runtime22.jsx)(NpsSurvey, {}),
      (0, import_jsx_runtime22.jsx)(PluginsInitializer, {
        children: (0, import_jsx_runtime22.jsx)(DndProvider, {
          backend: HTML5Backend,
          children: (0, import_jsx_runtime22.jsxs)(R, {
            background: "neutral100",
            children: [
              (0, import_jsx_runtime22.jsx)(i1, {
                children: formatMessage({
                  id: "skipToContent",
                  defaultMessage: "Skip to content"
                })
              }),
              (0, import_jsx_runtime22.jsxs)(T, {
                height: "100dvh",
                direction: {
                  initial: "column",
                  large: "row"
                ...
                alignItems: "flex-start",
                children: [
                  (0, import_jsx_runtime22.jsx)(LeftMenu, {
                    generalSectionLinks,
                    pluginsSectionLinks,
                    topMobileNavigation,
                    burgerMobileNavigation
                  ...
                  (0, import_jsx_runtime22.jsxs)(T, {
                    ...
                    children: [
                      (0, import_jsx_runtime22.jsx)(UpsellBanner, {}),
                      (0, import_jsx_runtime22.jsx)(Outlet, {})
                    ]
                  })
                ]
              })
...
var PrivateAdminLayout = () => {
  return (0, import_jsx_runtime22.jsx)(PrivateRoute, {
    children: (0, import_jsx_runtime22.jsx)(AdminLayout, {})
  });
};
...
//# sourceMappingURL=AuthenticatedLayout-LBCWTBQE.js.map
