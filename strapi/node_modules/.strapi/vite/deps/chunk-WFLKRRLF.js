import {
  ...
  HOOKS
} from "./chunk-VFONTEDP.js";
import {
  useNpsSurveySettings
} from "./chunk-HSHFMGB2.js";
import {
  require_pick
} from "./chunk-DH6AMUKQ.js";
import {
  getBasename
} from "./chunk-TKXHHSNW.js";
import {
  Login
} from "./chunk-JC4RFFMP.js";
import {
  MemoizedInputRenderer
} from "./chunk-PZOZ6NJT.js";
import {
  Form
...
import {
  HistoryProvider
} from "./chunk-JM3O2J3E.js";
import {
  useClipboard
} from "./chunk-5CEB7SBJ.js";
import {
  GuidedTourContext,
  useAIAvailability
...
import {
  useGetAiUsageQuery
} from "./chunk-2VJKO5BA.js";
import {
  _setPrototypeOf
} from "./chunk-MBK4V2X7.js";
import {
  useEnterprise
...
import {
  ...
  getEERoutes
} from "./chunk-CCQXIRUY.js";
import {
  require_client
} from "./chunk-3MST3H25.js";
import {
  Link,
  NavLink,
  Navigate,
...
function useMutation(arg1, arg2, arg3) {
  ...
  var _React$useState = import_react2.default.useState(0), forceUpdate = _React$useState[1];
  var options = parseMutationArgs(arg1, arg2, arg3);
  var queryClient2 = useQueryClient();
  var obsRef = import_react2.default.useRef();
  if (!obsRef.current) {
  ...
  var mutate = import_react2.default.useCallback(function(variables, mutateOptions) {
...
var QueryErrorResetBoundaryContext = import_react3.default.createContext(createValue());
...
// node_modules/@strapi/admin/dist/admin/admin/src/assets/images/logo-strapi-2022.svg.mjs
...
function useAIUsageWarning(threshold = 0.8) {
  ...
  const warningLevelsRef = (0, import_react9.useRef)(/* @__PURE__ */ new Set());
...
var Theme = ({ children, themes }) => {
  ...
  const [systemTheme, setSystemTheme] = React9.useState();
  ...
  return (0, import_jsx_runtime3.jsxs)(Ym, {
    locale,
    /**
...
var App = ({ strapi, store }) => {
  ...
  return (0, import_jsx_runtime5.jsx)(Providers, {
    strapi,
    store,
    children: (0, import_jsx_runtime5.jsxs)(import_react12.Suspense, {
      fallback: (0, import_jsx_runtime5.jsx)(Page.Loading, {}),
      children: [
        (0, import_jsx_runtime5.jsx)(GlobalNotifications, {}),
        window.strapi.future.isEnabled("unstableMediaLibrary") && globalComponents.map(({ name, Component }) => (0, import_jsx_runtime5.jsx)(Component, {}, name)),
...
\`\`\`
    ...
    return (0, import_jsx_runtime6.jsx)(t1, {
      height: "100%",
      children: (0, import_jsx_runtime6.jsx)(T, {
        alignItems: "center",
        height: "100%",
              ...
              children: [
                ...
                (0, import_jsx_runtime6.jsx)(I, {
                  ...
                  children: formatMessage({
                    ...
                    link: (0, import_jsx_runtime6.jsx)(Vc, {
                      isExternal: true,
            ...
            (0, import_jsx_runtime6.jsxs)(T, {
              ...
              children: [
                ...
                (0, import_jsx_runtime6.jsx)(zn, {
                  onClick: handleClick,
                  variant: "tertiary",
                  startIcon: (0, import_jsx_runtime6.jsx)($5, {}),
                  children: formatMessage({
                    id: "app.error.copy",
  ...
  return (0, import_jsx_runtime7.jsxs)(Page.Main, {
    ...
    children: [
      ...
      (0, import_jsx_runtime7.jsx)(Layouts.Content, {
        children: (0, import_jsx_runtime7.jsx)(Jm, {
          action: (0, import_jsx_runtime7.jsx)(e1, {
            tag: Link,
            variant: "secondary",
            endIcon: (0, import_jsx_runtime7.jsx)(E2, {}),
            to: "/",
            children: formatMessage({
          ...
          hasRadius: true,
          icon: (0, import_jsx_runtime7.jsx)(l1, {
            width: "16rem"
          }),
          shadow: "tableShadow"
        })
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import("./ListPage-4YHUGF3M.js");
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import("./SingleSignOnPage-HRYJTUKP.js");
        return {
...
var ForgotPassword = () => {
  ...
  return (0, import_jsx_runtime8.jsx)(UnauthenticatedLayout, {
    children: (0, import_jsx_runtime8.jsxs)(t1, {
      children: [
          ...
          children: [
            (0, import_jsx_runtime8.jsxs)(Column, {
              children: [
                ...
                error ? (0, import_jsx_runtime8.jsx)(I, {
        ...
        (0, import_jsx_runtime8.jsx)(T, {
          justifyContent: "center",
          children: (0, import_jsx_runtime8.jsx)(R, {
            paddingTop: 4,
            children: (0, import_jsx_runtime8.jsx)(Vc, {
              tag: NavLink,
              to: "/auth/login",
              children: formatMessage({
                id: "Auth.link.ready",
  ...
  return (0, import_jsx_runtime9.jsx)(UnauthenticatedLayout, {
    children: (0, import_jsx_runtime9.jsxs)(t1, {
      children: [
        (0, import_jsx_runtime9.jsx)(LayoutContent, {
          children: (0, import_jsx_runtime9.jsxs)(Column, {
            children: [
              ...
              (0, import_jsx_runtime9.jsx)(R, {
                paddingTop: 6,
                paddingBottom: 7,
                children: (0, import_jsx_runtime9.jsx)(I, {
                  tag: "h1",
                  variant: "alpha",
                  children: formatMessage({
        ...
        (0, import_jsx_runtime9.jsx)(T, {
          justifyContent: "center",
          children: (0, import_jsx_runtime9.jsx)(R, {
            paddingTop: 4,
            children: (0, import_jsx_runtime9.jsx)(Vc, {
              tag: NavLink,
              to: "/auth/login",
              children: formatMessage({
                id: "Auth.link.signin",
...
var Oops = () => {
  ...
  return (0, import_jsx_runtime10.jsx)(UnauthenticatedLayout, {
    children: (0, import_jsx_runtime10.jsxs)(t1, {
      children: [
        ...
        (0, import_jsx_runtime10.jsx)(T, {
          justifyContent: "center",
          children: (0, import_jsx_runtime10.jsx)(R, {
            paddingTop: 4,
            children: (0, import_jsx_runtime10.jsx)(Vc, {
              tag: NavLink,
              to: "/auth/login",
              children: formatMessage({
                id: "Auth.link.signin",
...
var Register = ({ hasAdmin }) => {
  const { toggleNotification } = useNotification();
  const navigate = useNavigate();
  const [submitCount, setSubmitCount] = React11.useState(0);
  const [apiError, setApiError] = React11.useState();
  const { trackUsage } = useTracking();
  const { formatMessage } = useIntl();
  const { search: searchString } = useLocation();
  const query = React11.useMemo(() => new URLSearchParams(searchString), [
    searchString
  ]);
      ...
      children: [
        (0, import_jsx_runtime11.jsxs)(T, {
          ...
          children: [
            ...
            apiError ? (0, import_jsx_runtime11.jsx)(I, {
              id: "global-form-error",
              role: "alert",
              tabIndex: -1,
              textColor: "danger600",
        ...
        (0, import_jsx_runtime11.jsx)(Form, {
          ...
          children: (0, import_jsx_runtime11.jsxs)(T, {
            direction: "column",
            alignItems: "stretch",
            gap: 6,
            marginTop: 7,
            children: [
              (0, import_jsx_runtime11.jsx)(Um.Root, {
                gap: 4,
                children: [
                  {
                    label: formatMessage({
                ...
                ].map(({ size, ...field }) => (0, import_jsx_runtime11.jsx)(Um.Item, {
                  xs: 12,
                  m: size,
                  direction: "column",
                  alignItems: "stretch",
        ...
        (match == null ? void 0 : match.params.authType) === "register" && (0, import_jsx_runtime11.jsx)(R, {
          paddingTop: 4,
          children: (0, import_jsx_runtime11.jsx)(T, {
            justifyContent: "center",
            children: (0, import_jsx_runtime11.jsx)(Vc, {
              tag: NavLink,
              to: "/auth/login",
              children: formatMessage({
...
var ResetPassword = () => {
  ...
  const navigate = useNavigate();
  const { search: searchString } = useLocation();
  const query = React12.useMemo(() => new URLSearchParams(searchString), [
    searchString
  ]);
  const { _unstableFormatAPIError: formatAPIError } = useAPIErrorHandler();
  ...
  return (0, import_jsx_runtime12.jsx)(UnauthenticatedLayout, {
    children: (0, import_jsx_runtime12.jsxs)(t1, {
      children: [
          ...
          children: [
            (0, import_jsx_runtime12.jsxs)(Column, {
              children: [
                ...
                error ? (0, import_jsx_runtime12.jsx)(I, {
                  id: "global-form-error",
                  role: "alert",
                  tabIndex: -1,
                  textColor: "danger600",
            ...
            (0, import_jsx_runtime12.jsx)(Form, {
              ...
              children: (0, import_jsx_runtime12.jsxs)(T, {
                direction: "column",
                alignItems: "stretch",
                gap: 6,
                children: [
        ...
        (0, import_jsx_runtime12.jsx)(T, {
          justifyContent: "center",
          children: (0, import_jsx_runtime12.jsx)(R, {
            paddingTop: 4,
            children: (0, import_jsx_runtime12.jsx)(Vc, {
              tag: NavLink,
              to: "/auth/login",
              children: formatMessage({
                id: "Auth.link.ready",
...
var AuthPage = () => {
  ...
  const { hasAdmin } = data ?? {};
  const Login$1 = useEnterprise(Login, async () => (await import("./Login-ZUK22K2A.js")).LoginEE);
  const forms = useEnterprise(FORMS, async () => (await import("./constants-DARH2LK5.js")).FORMS, {
...
var isAdminTokensFutureEnabled = () => window.strapi.future.isEnabled("adminTokens") === true;
var ADMIN_TOKEN_ROUTES = [
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-RMGZLUMN.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-RY7U5B2F.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-JM2LKQOC.js");
      return {
...
var ROUTES_CE = () => [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-LTNHRG7F.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-PLLR6PID.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-IMTMI27K.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-WSNO72I3.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-C77F64AD.js");
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-52GC6P4B.js");
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const editWebhook = await import("./EditPage-NPSF4LHD.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-GKKVN2JU.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-SZNSCKGG.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-KHHDTCV2.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-CFFGMSS4.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-MHTM3CGT.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-MQBU2YNF.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditView-YKUBNPDI.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import("./InstalledPlugins-FD647UBO.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import("./PurchaseAuditLogs-RY5ZYTI7.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await import("./PurchaseSingleSignOn-23Z6GOY3.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseContentHistory } = await import("./PurchaseContentHistory-7EN4RAQA.js");
      return {
...
var getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import("./UseCasePage-5LQOR3WL.js");
      return {
...
var getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import("./HomePage-HBZZRQFZ.js");
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import("./ProfilePage-47P2SCIG.js");
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import("./Layout-O3D3VSH3.js");
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import("./ApplicationInfoPage-RQRATV3R.js");
          return {
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await import("./AuthenticatedLayout-LBCWTBQE.js");
              return {
...
function __variableDynamicImportRuntime5__(path) {
  switch (path) {
    case "./translations/ar.json":
      return import("./ar.json-GM23UYXU.js");
    case "./translations/ca.json":
      return import("./ca.json-R44MTG4O.js");
    case "./translations/cs.json":
      return import("./cs.json-XSDLPNFV.js");
    case "./translations/de.json":
      return import("./de.json-UUT6IEEA.js");
    case "./translations/dk.json":
      return import("./dk.json-SXWBJRHV.js");
    case "./translations/en.json":
      return import("./en.json-KGIEFW7Z.js");
    case "./translations/es.json":
      return import("./es.json-2GSUKORY.js");
    case "./translations/eu.json":
      return import("./eu.json-L3STS5SS.js");
    case "./translations/fi.json":
      return import("./fi.json-6ESLS5M5.js");
    case "./translations/fr.json":
      return import("./fr.json-VPHFYTWP.js");
    case "./translations/gu.json":
      return import("./gu.json-ZVRWYJEO.js");
    case "./translations/he.json":
      return import("./he.json-BZKSXCL7.js");
    case "./translations/hi.json":
      return import("./hi.json-KXVMFSKG.js");
    case "./translations/hu.json":
      return import("./hu.json-SMNWVMH2.js");
    case "./translations/id.json":
      return import("./id.json-LXXQXNRF.js");
    case "./translations/it.json":
      return import("./it.json-AQKZ57AK.js");
    case "./translations/ja.json":
      return import("./ja.json-RR2OHIYV.js");
    case "./translations/ko.json":
      return import("./ko.json-MPAATXY6.js");
    case "./translations/ml.json":
      return import("./ml.json-EAD5CT2R.js");
    case "./translations/ms.json":
      return import("./ms.json-WM3XRBVB.js");
    case "./translations/nl.json":
      return import("./nl.json-CD4OXTUC.js");
    case "./translations/no.json":
      return import("./no.json-PJ6HBHDJ.js");
    case "./translations/pl.json":
      return import("./pl.json-FJP3I2QS.js");
    case "./translations/pt-BR.json":
      return import("./pt-BR.json-6C7PGBJZ.js");
    case "./translations/pt.json":
      return import("./pt.json-7I2SI5N7.js");
    case "./translations/ru.json":
      return import("./ru.json-T2V5GU2I.js");
    case "./translations/sa.json":
      return import("./sa.json-MNOSNB4H.js");
    case "./translations/sk.json":
      return import("./sk.json-H7LKW7VO.js");
    case "./translations/sv.json":
      return import("./sv.json-EEAAMU3M.js");
    case "./translations/th.json":
      return import("./th.json-4UIX2VUH.js");
    case "./translations/tr.json":
      return import("./tr.json-E5KZOLWP.js");
    case "./translations/uk.json":
      return import("./uk.json-D3ZOXXYO.js");
    case "./translations/vi.json":
      return import("./vi.json-A3BNF4B7.js");
    case "./translations/zh-Hans.json":
      return import("./zh-Hans.json-ISEZWVQB.js");
    case "./translations/zh.json":
      return import("./zh.json-YGG4VTW6.js");
    default:
      return new Promise(function(resolve, reject) {
...
function __variableDynamicImportRuntime4__(path) {
  switch (path) {
    case "./translations/en-GB.js":
      return import("./en-GB-4GOFFLTR.js");
    default:
      return new Promise(function(resolve, reject) {
        (typeof queueMicrotask === "function" ? queueMicrotask : setTimeout)(
          reject.bind(null, new Error("Unknown variable dynamic import: " + path))
...
var { INJECT_COLUMN_IN_TABLE, INJECT_LIST_VIEW_FILTERS, MUTATE_COLLECTION_TYPES_LINKS, MUTATE_EDIT_VIEW_LAYOUT, MUTATE_SINGLE_TYPES_LINKS } = HOOKS;
var StrapiApp = class {
    ...
    this.widgets.register([
      {
        ...
        component: async () => {
          const { ProfileWidget } = await import("./Widgets-WQRY6CQZ.js");
      ...
      },
      {
        ...
        component: async () => {
          const { KeyStatisticsWidget } = await import("./Widgets-WQRY6CQZ.js");
      ...
      },
      {
        ...
        component: async () => {
          const { DeployNowWidget } = await import("./Widgets-WQRY6CQZ.js");
      ...
      this.widgets.register([
        {
          ...
          component: async () => {
            const { AuditLogsWidget } = await import("./Widgets-S474TPB7.js");
  ...
  async loadAdminTrads() {
    const adminLocales = await Promise.all(this.configurations.locales.map(async (locale) => {
      try {
        const { default: data } = await __variableDynamicImportRuntime4__(`./translations/${locale}.js`);
        return {
          data,
          locale
        };
        ...
        try {
          const { default: data } = await __variableDynamicImportRuntime5__(`./translations/${locale}.json`);
          return {
            data,
            locale
          };
  ...
  constructor({ config, appPlugins } = {}) {
    ...
    this.createCustomConfigurations = (customConfig) => {
      ...
      if (customConfig.theme) {
        ...
        if (lightTheme) (0, import_merge.default)(this.configurations.themes.light, lightTheme);
        if (darkTheme) (0, import_merge.default)(this.configurations.themes.dark, darkTheme);
      }
      if (((_d = customConfig.notifications) == null ? void 0 : _d.releases) !== void 0) {
...
var useIsMounted = () => {
  const isMounted = React13.useRef(false);
...
// node_modules/@strapi/admin/dist/admin/admin/src/hooks/useForceUpdate.mjs
var useForceUpdate = () => {
  const [tick, update] = React14.useState();
...
var useThrottledCallback = (callback, wait, options) => {
  const throttledCallback = (0, import_react15.useMemo)(() => (0, import_throttle.default)(callback, wait, options), [
    callback,
    options,
    wait
  ]);
...
var DescriptionComponentRenderer = ({ children, props, descriptions }) => {
  const statesRef = React15.useRef({});
  const [tick, forceUpdate] = useForceUpdate();
  const requestHandle = React15.useRef(null);
  const requestUpdate = React15.useCallback(() => {
  ...
  const update = React15.useCallback((id, description) => {
    if (description === null) {
  ...
  const ids2 = React15.useMemo(() => descriptions.map((description) => getCompId(description)), [
    descriptions
  ]);
  const states = React15.useMemo(
    () => ids2.map((id) => {
      var _a;
...
var Description = React15.memo(({ description, id, props, update }) => {
...
var useShallowCompareMemoize = (value) => {
  const ref = React15.useRef(void 0);
...
var useShallowCompareEffect = (callback, dependencies) => {
  React15.useEffect(callback, useShallowCompareMemoize(dependencies));
};
...
function useDebounce(value, delay) {
  const [debouncedValue, setDebouncedValue] = React16.useState(value);
  React16.useEffect(() => {
...
//# sourceMappingURL=chunk-WFLKRRLF.js.map
