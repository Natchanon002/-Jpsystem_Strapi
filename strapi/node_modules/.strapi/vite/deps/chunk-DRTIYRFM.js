...
var EventsHeaders = ({ getHeaders = getCEHeaders }) => {
  ...
  return (0, import_jsx_runtime.jsx)(r0, {
    children: (0, import_jsx_runtime.jsxs)(s0, {
      children: [
        (0, import_jsx_runtime.jsx)(n0, {
        ...
        headers.map((header) => {
          if ([
            ...
            return (0, import_jsx_runtime.jsx)(n0, {
              title: formatMessage({
...
var EventsBody = ({ providedEvents }) => {
  ...
  return (0, import_jsx_runtime.jsx)(o0, {
...
var EventsRow = ({ disabledEvents = [], name, events = [], inputValue = [], handleSelect, handleSelectAll }) => {
  ...
  return (0, import_jsx_runtime.jsxs)(s0, {
    children: [
      (0, import_jsx_runtime.jsx)(Na, {
      ...
      events.map((event) => {
        return (0, import_jsx_runtime.jsx)(Na, {
          textAlign: "center",
      ...
      events.length < targetColumns && (0, import_jsx_runtime.jsx)(Na, {
...
//# sourceMappingURL=chunk-DRTIYRFM.js.map
