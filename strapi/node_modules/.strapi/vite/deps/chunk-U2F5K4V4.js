...
// node_modules/@strapi/admin/dist/admin/ee/admin/src/hooks/useAIAvailability.mjs
...
var usePersistentState = (key, defaultValue) => {
  const [value, setValue] = (0, import_react.useState)(() => readFromStorage(key, defaultValue));
  const currentKeyRef = (0, import_react.useRef)(key);
...
var usePersistentStateScope = () => {
  const { data: initData } = useInitQuery();
  return initData == null ? void 0 : initData.uuid;
};
...
var getDefaultTours = () => Object.keys(tours).reduce((acc, tourName) => {
  acc[tourName] = {
    currentStep: 0,
    isCompleted: false,
    tourType: void 0
...
var migrateTours = (storedTourState) => {
  if (!(storedTourState == null ? void 0 : storedTourState.tours) || typeof storedTourState.tours !== "object") {
    return {
      ...storedTourState,
      tours: getDefaultTours(),
      enabled: (storedTourState == null ? void 0 : storedTourState.enabled) ?? true,
      completedActions: Array.isArray(storedTourState == null ? void 0 : storedTourState.completedActions) ? storedTourState.completedActions : [],
      hidden: (storedTourState == null ? void 0 : storedTourState.hidden) ?? false
    };
  }
...
var StepCount = ({ tourName, displayedCurrentStep, displayedTourLength }) => {
  ...
  return (0, import_jsx_runtime2.jsx)(I, {
    variant: "omega",
    fontSize: "12px",
...
var GotItAction = ({ onClick }) => {
  return (0, import_jsx_runtime2.jsx)(zn, {
    onClick,
    children: (0, import_jsx_runtime2.jsx)(message_default, {
      id: "tours.gotIt",
...
var DefaultActions = ({ showSkip, showPrevious, to, tourName, onNextStep, onPreviousStep }) => {
  ...
  return (0, import_jsx_runtime2.jsxs)(T, {
    gap: 2,
    children: [
      showSkip && (0, import_jsx_runtime2.jsx)(zn, {
        variant: "tertiary",
        onClick: handleSkip,
        children: (0, import_jsx_runtime2.jsx)(message_default, {
          id: "tours.skip",
      ...
      !showSkip && showPrevious && (0, import_jsx_runtime2.jsx)(zn, {
        variant: "tertiary",
      ...
      to ? (0, import_jsx_runtime2.jsx)(e1, {
        tag: NavLink,
        to,
...
var ActionsContainer = gt(T)`
  border-top: ${({ theme }) => `1px solid ${theme.colors.neutral150}`};
`;
var ContentContainer = gt(R)`
  p {
...
`;
var PopoverArrow = gt(c1.Arrow)`
  fill: ${({ theme }) => theme.colors.neutral0};
  transform: translateY(-16px) rotate(-90deg);
`;
var createStepComponents = (tourName) => ({
  Root: React2.forwardRef(({ withArrow = true, ...props }, ref) => {
    return (0, import_jsx_runtime2.jsxs)(c1.Content, {
      ref,
  ...
  Title: (props) => {
    return (0, import_jsx_runtime2.jsx)(R, {
      ...
      paddingBottom: 1,
      width: "100%",
      children: "children" in props ? props.children : (0, import_jsx_runtime2.jsx)(I, {
        tag: "h1",
...
var CopyAPIToken = ({ Step, dispatch }) => (0, import_jsx_runtime3.jsxs)(Step.Root, {
  ...
  children: [
    ...
    (0, import_jsx_runtime3.jsx)(Step.Content, {
      ...
      values: {
        spacer: (0, import_jsx_runtime3.jsx)(R, {
          paddingTop: 2
        }),
        a: (msg) => (0, import_jsx_runtime3.jsx)(Vc, {
          isExternal: true,
...
var GuidedTourTooltip = ({ children, ...props }) => {
  ...
  if (!state.enabled || state.hidden || false) {
    return children;
  }
...
var GuidedTourOverlay = gt(R)`
  position: fixed;
  top: 0;
  left: 0;
  right: 0;
  bottom: 0;
  background-color: ${({ theme }) => ol(theme.colors.neutral800, 0.2)};
  z-index: 10;
`;
var GuidedTourTooltipImpl = ({ children, content, tourName, step, when }) => {
  ...
  const tourState = (_a = state.tours) == null ? void 0 : _a[tourName];
  const isCurrentStep = (tourState == null ? void 0 : tourState.currentStep) === step;
  const isStepConditionMet = when ? when(state.completedActions) : true;
  const isPopoverOpen = ((_b = guidedTourMeta == null ? void 0 : guidedTourMeta.data) == null ? void 0 : _b.isFirstSuperAdminUser) && !(tourState == null ? void 0 : tourState.isCompleted) && isCurrentStep && isStepConditionMet;
  React3.useEffect(() => {
  ...
  const hasApiSchema = Object.keys(((_c = guidedTourMeta == null ? void 0 : guidedTourMeta.data) == null ? void 0 : _c.schemas) ?? {}).filter((key) => key.startsWith("api::")).length > 0;
  React3.useEffect(() => {
    if (hasApiSchema) {
      dispatch({
  ...
  return (0, import_jsx_runtime6.jsxs)(import_jsx_runtime6.Fragment, {
    children: [
      isPopoverOpen && (0, import_jsx_runtime6.jsx)(al, {
        children: (0, import_jsx_runtime6.jsx)(GuidedTourOverlay, {})
      }),
      (0, import_jsx_runtime6.jsxs)(c1.Root, {
        open: isPopoverOpen,
        children: [
          (0, import_jsx_runtime6.jsx)(c1.Anchor, {
            children
          }),
          content({
            Step,
...
//# sourceMappingURL=chunk-U2F5K4V4.js.map
