...
var CustomRelationInput = (props) => {
  ...
  if (!formattedFieldValue || formattedFieldValue.results.length === 0 && formattedFieldValue.meta.missingCount === 0) {
    return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
      children: [
        (0, import_jsx_runtime.jsx)(Vm.Label, {
  ...
  return (0, import_jsx_runtime.jsxs)(R, {
    children: [
      (0, import_jsx_runtime.jsx)(Vm.Label, {
        children: props.label
      }),
      results.length > 0 && (0, import_jsx_runtime.jsx)(T, {
        direction: "column",
        gap: 2,
        marginTop: 1,
        alignItems: "stretch",
            ...
            children: [
              (0, import_jsx_runtime.jsx)(R, {
                ...
                children: (0, import_jsx_runtime.jsx)(Tr, {
                  label,
                  children: isAdminUserRelation ? (0, import_jsx_runtime.jsx)(I, {
                    children: label
...
var rulesEngine = createRulesEngine();
var getPanelConditionDependencyPaths = (panel) => {
  var _a, _b;
...
var FormPanel = ({ panel }) => {
  ...
  const conditionDependencyPaths = React2.useMemo(() => getPanelConditionDependencyPaths(panel), [
    panel
  ]);
  ...
  if (panel.some((row) => row.some((field) => field.type === "dynamiczone"))) {
    ...
    return (0, import_jsx_runtime2.jsx)(Um.Root, {
      gap: 4,
      children: (0, import_jsx_runtime2.jsx)(Um.Item, {
        xs: 12,
        direction: "column",
        alignItems: "stretch",
...
var VersionContent = () => {
  ...
  return (0, import_jsx_runtime2.jsx)(Layouts.Content, {
    children: (0, import_jsx_runtime2.jsxs)(R, {
      paddingBottom: {
        initial: 0,
        large: 8
      },
        ...
        removedAttributesAsFields.length > 0 && (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, {
          children: [
            (0, import_jsx_runtime2.jsx)(R, {
              ...
              children: (0, import_jsx_runtime2.jsx)(yl, {})
            }),
                  ...
                  children: [
                    ...
                    (0, import_jsx_runtime2.jsx)(I, {
                      ...
                      children: formatMessage({
                        ...
                        b: (chunks) => (0, import_jsx_runtime2.jsx)(I, {
                          variant: "pi",
                          fontWeight: "bold",
                          children: chunks
                        })
...
var VersionHeader = ({ headerId }) => {
  ...
  return (0, import_jsx_runtime3.jsxs)(_m.Root, {
    ...
    children: [
      (0, import_jsx_runtime3.jsx)(Layouts.BaseHeader, {
        ...
        subtitle: (0, import_jsx_runtime3.jsx)(I, {
          variant: "epsilon",
        ...
        navigationAction: (0, import_jsx_runtime3.jsx)(Vc, {
          startIcon: (0, import_jsx_runtime3.jsx)(U2, {}),
          tag: NavLink,
        ...
        sticky: false,
        primaryAction: (0, import_jsx_runtime3.jsx)(_m.Trigger, {
      ...
      (0, import_jsx_runtime3.jsx)(ConfirmDialog, {
        ...
        endAction: (0, import_jsx_runtime3.jsx)(zn, {
          fullWidth: true,
          variant: "secondary",
        ...
        children: (0, import_jsx_runtime3.jsxs)(T, {
          ...
          children: [
            (0, import_jsx_runtime3.jsx)(T, {
              justifyContent: "center",
              children: (0, import_jsx_runtime3.jsx)(Nn, {
                width: "24px",
                height: "24px",
                fill: "danger600"
              })
...
var BlueText = (children) => (0, import_jsx_runtime4.jsx)(I, {
  textColor: "primary600",
  variant: "pi",
  children
});
var VersionAuthor = ({ version, isCurrent }) => {
  const { formatMessage } = useIntl();
...
var VersionCard = ({ version, isCurrent }) => {
  ...
  const [{ query }] = useQueryParams();
  const setIsOpen = useActionsDrawer("VersionCard", (s) => s == null ? void 0 : s.setIsOpen, false);
      ...
      (0, import_jsx_runtime4.jsxs)(T, {
        ...
        children: [
          ...
          (0, import_jsx_runtime4.jsx)(I, {
            ...
            variant: "pi",
            textColor: "neutral600",
            children: (0, import_jsx_runtime4.jsx)(VersionAuthor, {
              version,
              isCurrent
            })
          })
...
var VersionsListItems = () => {
  ...
  return (0, import_jsx_runtime4.jsxs)(R, {
    ...
    overflow: "auto",
    children: [
      versions.meta.pagination.page > 1 && (0, import_jsx_runtime4.jsx)(R, {
        paddingTop: 4,
        textAlign: "center",
      ...
      versions.meta.pagination.page < versions.meta.pagination.pageCount && (0, import_jsx_runtime4.jsx)(R, {
        paddingBottom: 4,
        textAlign: "center",
        children: (0, import_jsx_runtime4.jsx)(PaginationButton, {
          page: page + 1,
...
var VersionsList = () => {
  ...
  return !isMobile ? (0, import_jsx_runtime4.jsxs)(T, {
    shrink: 0,
    direction: "column",
    alignItems: "stretch",
    width: {
    ...
    children: [
      ...
      (0, import_jsx_runtime4.jsx)(VersionsListItems, {})
    ]
  }) : (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, {
    children: [
      (0, import_jsx_runtime4.jsxs)(ActionsDrawer.Root, {
        hasContent: true,
        hasSideNav: true,
        children: [
          (0, import_jsx_runtime4.jsx)(ActionsDrawer.Overlay, {}),
          (0, import_jsx_runtime4.jsx)(ActionsDrawer.Header, {
            children: currentVersion && (0, import_jsx_runtime4.jsxs)(T, {
              gap: 2,
              overflow: "hidden",
              children: [
                (0, import_jsx_runtime4.jsx)(R, {
                ...
                currentVersion.status && (0, import_jsx_runtime4.jsx)(DocumentStatus, {
          ...
          (0, import_jsx_runtime4.jsx)(ActionsDrawer.Content, {
            children: (0, import_jsx_runtime4.jsx)(VersionsListItems, {})
          })
        ]
      }),
      (0, import_jsx_runtime4.jsx)(R, {
  ...
  if (!versionsResponse.isError && !((_b = (_a = versionsResponse.data) == null ? void 0 : _a.data) == null ? void 0 : _b.length)) {
    return (0, import_jsx_runtime5.jsx)(import_jsx_runtime5.Fragment, {
      children: (0, import_jsx_runtime5.jsx)(Page.NoData, {
        action: (0, import_jsx_runtime5.jsx)(Vc, {
          tag: NavLink,
  ...
  return (0, import_jsx_runtime5.jsxs)(import_jsx_runtime5.Fragment, {
    children: [
      ...
      (0, import_jsx_runtime5.jsx)(HistoryProvider, {
        ...
        page,
        mainField,
        children: (0, import_jsx_runtime5.jsxs)(T, {
          direction: {
            initial: "column",
            medium: "row"
          },
...
var ProtectedHistoryPageImpl = () => {
  ...
  if (error || !slug) {
    return (0, import_jsx_runtime5.jsx)(R, {
      width: "100dvw",
      position: "fixed",
      top: {
...
var ProtectedHistoryPage = () => {
  return (0, import_jsx_runtime5.jsx)(al, {
    children: (0, import_jsx_runtime5.jsx)(P1, {
...
//# sourceMappingURL=History-DM63IG23.js.map
