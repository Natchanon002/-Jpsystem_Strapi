...
// node_modules/@strapi/upload/dist/admin/pages/App/MediaLibrary.mjs
...
var CardActionsContainer = gt(ud)`
  opacity: 0;
  z-index: 1;
...
var AssetCardActions = ({ asset }) => {
  ...
  return (0, import_jsx_runtime.jsxs)(CardActionsContainer, {
    ...
    position: "end",
    children: [
      (0, import_jsx_runtime.jsxs)(_m.Root, {
        children: [
      ...
      (0, import_jsx_runtime.jsxs)(n1.Root, {
        open: isEditModalOpen,
        onOpenChange: setIsEditModalOpen,
        children: [
          (0, import_jsx_runtime.jsx)(n1.Trigger, {
            children: (0, import_jsx_runtime.jsx)(st, {
              label: formatMessage({
          ...
          (0, import_jsx_runtime.jsx)(n1.Content, {
...
var Asset = ({ assetType, thumbnailUrl, assetUrl, asset }) => {
  ...
  switch (assetType) {
    case AssetType.Image:
      return (0, import_jsx_runtime.jsx)(Mm, {
        src: thumbnailUrl,
        size: "S",
      ...
      children: [
          ...
          children: (0, import_jsx_runtime.jsxs)(StyledCard, {
            ...
            children: [
              ...
              (0, import_jsx_runtime.jsx)(StyledCardBody, {
                children: (0, import_jsx_runtime.jsxs)(Im, {
                  width: "100%",
                  children: [
                    (0, import_jsx_runtime.jsxs)(T, {
                      ...
                      children: [
                        (0, import_jsx_runtime.jsx)(I, {
                          tag: "h2",
                          children: (0, import_jsx_runtime.jsx)(Bm, {
                            tag: "span",
                            children: asset.name
                          })
                        }),
                        (0, import_jsx_runtime.jsx)(Dm, {
                          children: formatMessage(getAssetBadgeLabel(assetType))
                        })
                      ]
                    }),
                    (0, import_jsx_runtime.jsx)(T, {
                      children: (0, import_jsx_runtime.jsxs)(zm, {
                        children: [
        ...
        (0, import_jsx_runtime.jsx)(Um.Item, {
          ...
          children: (0, import_jsx_runtime.jsxs)(T, {
            ...
            gap: 2,
            children: [
              (0, import_jsx_runtime.jsxs)(Vm.Root, {
                name: "caption",
                children: [
                  (0, import_jsx_runtime.jsx)(T, {
                    alignItems: "center",
                    gap: 2,
                    children: (0, import_jsx_runtime.jsx)(Vm.Label, {
                  ...
                  (0, import_jsx_runtime.jsx)(X0, {
                    ...
                    endAction: !wasCaptionChanged && asset.caption && (0, import_jsx_runtime.jsx)(Sn, {
                      width: "16px",
                      height: "16px",
                      fill: "#AC73E6"
                    }),
              ...
              (0, import_jsx_runtime.jsxs)(Vm.Root, {
                ...
                children: [
                  ...
                  (0, import_jsx_runtime.jsx)(X0, {
                    ...
                    endAction: !wasAltTextChanged && asset.alternativeText && (0, import_jsx_runtime.jsx)(Sn, {
                      width: "16px",
                      height: "16px",
                      fill: "#AC73E6"
                    }),
                  ...
                  (0, import_jsx_runtime.jsx)(Vm.Hint, {})
                ]
              })
            ]
          })
...
var AIAssetCardSkeletons = ({ count = 1 }) => {
  ...
  return skeletons.map((index) => (0, import_jsx_runtime.jsx)(R, {
    background: "neutral0",
    ...
    children: (0, import_jsx_runtime.jsxs)(Um.Root, {
      children: [
        (0, import_jsx_runtime.jsx)(Um.Item, {
          col: 5,
          alignItems: "stretch",
          children: (0, import_jsx_runtime.jsxs)(Rm, {
            height: "100%",
            width: "100%",
            borderStyle: "none",
            shadow: "none",
...
var ModalContent = ({ onClose }) => {
  ...
  if (state.assetsToUploadLength === 0) {
    return (0, import_jsx_runtime2.jsx)(n1.Content, {
  ...
  if (isUploading || state.assetsToUploadLength > 0 && state.uploadedAssets.length === 0 && !uploadError) {
    return (0, import_jsx_runtime2.jsxs)(n1.Content, {
      children: [
        (0, import_jsx_runtime2.jsx)(n1.Header, {
          children: (0, import_jsx_runtime2.jsx)(n1.Title, {
            children: formatMessage({
  ...
  if (uploadError) {
    return (0, import_jsx_runtime2.jsxs)(n1.Content, {
      children: [
        ...
        (0, import_jsx_runtime2.jsx)(n1.Body, {
        ...
        (0, import_jsx_runtime2.jsxs)(n1.Footer, {
          children: [
...
var AIUploadModal = ({ open, onClose, folderId = null }) => {
  ...
  return (0, import_jsx_runtime2.jsx)(AIUploadModalContext, {
    ...
    folderId,
    onClose: handleClose,
    children: (0, import_jsx_runtime2.jsx)(n1.Root, {
      open,
...
var FolderCardCheckbox = (props) => {
  ...
  return (0, import_jsx_runtime3.jsx)(R, {
    position: "relative",
    zIndex: 2,
...
// node_modules/@strapi/upload/dist/admin/pages/App/components/BulkActions.mjs
var import_jsx_runtime7 = __toESM(require_jsx_runtime(), 1);
var import_qs6 = __toESM(require_lib(), 1);

// node_modules/@strapi/upload/dist/admin/pages/App/components/BulkDeleteButton.mjs
...
var BulkDeleteButton = ({ selected, onSuccess }) => {
  ...
  return (0, import_jsx_runtime4.jsxs)(_m.Root, {
    children: [
      (0, import_jsx_runtime4.jsx)(_m.Trigger, {
        children: (0, import_jsx_runtime4.jsx)(zn, {
          variant: "danger-light",
          size: "S",
          startIcon: (0, import_jsx_runtime4.jsx)(bn, {}),
          children: formatMessage({
            id: "global.delete",
...
// node_modules/@strapi/upload/dist/admin/pages/App/components/BulkMoveButton.mjs
...
var BulkMoveDialog = ({ onClose, selected = [], currentFolder }) => {
  ...
  if (isLoading) {
    return (0, import_jsx_runtime5.jsx)(n1.Content, {
      children: (0, import_jsx_runtime5.jsx)(n1.Body, {
        children: (0, import_jsx_runtime5.jsx)(T, {
          justifyContent: "center",
          paddingTop: 4,
          paddingBottom: 4,
          children: (0, import_jsx_runtime5.jsx)(Fn, {
            children: formatMessage({
  ...
  return (0, import_jsx_runtime5.jsx)(n1.Content, {
    children: (0, import_jsx_runtime5.jsx)(Formik, {
      ...
      children: ({ values, errors, setFieldValue }) => (0, import_jsx_runtime5.jsxs)(Form, {
        noValidate: true,
        children: [
          (0, import_jsx_runtime5.jsx)(n1.Header, {
            children: (0, import_jsx_runtime5.jsx)(n1.Title, {
              children: formatMessage({
          ...
          (0, import_jsx_runtime5.jsx)(n1.Body, {
            children: (0, import_jsx_runtime5.jsx)(Um.Root, {
              gap: 4,
              children: (0, import_jsx_runtime5.jsx)(Um.Item, {
                xs: 12,
                direction: "column",
                alignItems: "stretch",
                children: (0, import_jsx_runtime5.jsxs)(Vm.Root, {
                  ...
                  children: [
                    ...
                    errors.destination && (0, import_jsx_runtime5.jsx)(I, {
                      variant: "pi",
                      tag: "p",
                      textColor: "danger600",
          ...
          (0, import_jsx_runtime5.jsxs)(n1.Footer, {
            children: [
              (0, import_jsx_runtime5.jsx)(n1.Close, {
...
var BulkMoveButton = ({ selected = [], onSuccess, currentFolder }) => {
  ...
  return (0, import_jsx_runtime6.jsxs)(n1.Root, {
    open: showConfirmDialog,
    onOpenChange: setShowConfirmDialog,
    children: [
      (0, import_jsx_runtime6.jsx)(n1.Trigger, {
        children: (0, import_jsx_runtime6.jsx)(zn, {
          variant: "secondary",
          size: "S",
          startIcon: (0, import_jsx_runtime6.jsx)(K5, {}),
          children: formatMessage({
            id: "global.move",
            defaultMessage: "Move"
          })
...
// node_modules/@strapi/upload/dist/admin/pages/App/components/EmptyOrNoPermissions.mjs
...
var EmptyOrNoPermissions = ({ canCreate, isFiltering, canRead, onActionClick }) => {
  ...
  return (0, import_jsx_runtime8.jsx)(EmptyAssets, {
    icon: !canRead ? Y : void 0,
    action: canCreate && !isFiltering && (0, import_jsx_runtime8.jsx)(zn, {
      variant: "secondary",
      startIcon: (0, import_jsx_runtime8.jsx)(sn, {}),
...
// node_modules/@strapi/upload/dist/admin/pages/App/components/Filters.mjs
...
var Filters = () => {
  ...
  return (0, import_jsx_runtime9.jsxs)(c1.Root, {
    open,
    onOpenChange: setOpen,
    children: [
      (0, import_jsx_runtime9.jsx)(c1.Trigger, {
        children: (0, import_jsx_runtime9.jsx)(zn, {
          variant: "tertiary",
          startIcon: (0, import_jsx_runtime9.jsx)(j5, {}),
          size: "S",
          children: formatMessage({
...
// node_modules/@strapi/upload/dist/admin/pages/App/components/Header.mjs
...
var Header = ({ breadcrumbs = null, canCreate, folder = null, onToggleEditFolderDialog, onToggleUploadAssetDialog }) => {
  ...
  return (0, import_jsx_runtime10.jsx)(Layouts.Header, {
    ...
    navigationAction: folder && (0, import_jsx_runtime10.jsx)(Vc, {
      tag: NavLink,
      startIcon: (0, import_jsx_runtime10.jsx)(U2, {}),
    ...
    primaryAction: canCreate && (0, import_jsx_runtime10.jsxs)(T, {
      gap: 2,
      width: "100%",
      children: [
        (0, import_jsx_runtime10.jsx)(zn, {
          startIcon: (0, import_jsx_runtime10.jsx)(sn, {}),
          variant: "secondary",
            ...
            startActions: (0, import_jsx_runtime11.jsxs)(import_jsx_runtime11.Fragment, {
              children: [
                canUpdate && isGridView && (assetCount > 0 || folderCount > 0) && (0, import_jsx_runtime11.jsx)(BoxWithHeight, {
                  ...
                  children: (0, import_jsx_runtime11.jsx)(Rr, {
            ...
            endActions: (0, import_jsx_runtime11.jsxs)(import_jsx_runtime11.Fragment, {
              children: [
                canConfigureView ? (0, import_jsx_runtime11.jsx)(ActionContainer, {
                  paddingTop: 1,
                  paddingBottom: 1,
                  children: (0, import_jsx_runtime11.jsx)(st, {
                    tag: Link,
                    to: {
                    ...
                    children: (0, import_jsx_runtime11.jsx)(u5, {})
                  })
                }) : null,
                (0, import_jsx_runtime11.jsx)(ActionContainer, {
                  ...
                  children: (0, import_jsx_runtime11.jsx)(st, {
                    ...
                    children: isGridView ? (0, import_jsx_runtime11.jsx)(A3, {}) : (0, import_jsx_runtime11.jsx)(k5, {})
                  })
                }),
                ...
                children: [
                  folderCount > 0 && (0, import_jsx_runtime11.jsx)(FolderGridList, {
                    ...
                    children: folders.map((folder) => {
                      ...
                      return (0, import_jsx_runtime11.jsx)(Um.Item, {
                        col: 3,
                        m: 4,
                        s: 6,
                        xs: 12,
                        ...
                        children: (0, import_jsx_runtime11.jsx)(FolderCard, {
                          ...
                          cardActions: (0, import_jsx_runtime11.jsx)(st, {
                            label: formatMessage({
                              id: getTrad("list.folder.edit"),
                              defaultMessage: "Edit folder"
                            }),
                            onClick: () => handleEditFolder(folder),
                            children: (0, import_jsx_runtime11.jsx)(_3, {})
                          }),
                  ...
                  assetCount > 0 && folderCount > 0 && (0, import_jsx_runtime11.jsx)(R, {
                    paddingTop: 6,
                    paddingBottom: 4,
                    children: (0, import_jsx_runtime11.jsx)(yl, {})
                  }),
...
// node_modules/@strapi/upload/dist/admin/pages/App/App.mjs
var ConfigureTheView = React6.lazy(async () => import("./ConfigureTheView-TNK3YED5.js").then((mod) => ({
...
//# sourceMappingURL=App-EBIBETIM.js.map
