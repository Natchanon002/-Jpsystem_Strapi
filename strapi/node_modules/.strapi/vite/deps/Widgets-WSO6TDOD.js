...
var CellTypography = gt(I)`
  ...
  white-space: nowrap;
`;
var RecentDocumentsTable = ({ documents, type, dynamicMaxWidth = BASE_MAX_WIDTH }) => {
  ...
  return (0, import_jsx_runtime.jsx)(C1, {
    colCount: 5,
    rowCount: (documents == null ? void 0 : documents.length) ?? 0,
    children: (0, import_jsx_runtime.jsx)(k1, {
      children: documents == null ? void 0 : documents.map((document) => (0, import_jsx_runtime.jsxs)(A1, {
      ...
      }, `${document.documentId}-${document.locale ?? "default"}`))
    })
  });
};
var LastEditedWidget = ({ columnWidth = 6 }) => {
  const { formatMessage } = useIntl();
...
var LastPublishedWidget = ({ columnWidth = 6 }) => {
  const { formatMessage } = useIntl();
  const { data, isLoading, error } = useGetRecentDocumentsQuery({
    action: "publish"
  });
...
var DonutChartSVG = ({ data }) => {
  ...
  return (0, import_jsx_runtime.jsxs)(T, {
    ...
    children: [
      ...
      tooltip.visible && tooltip.value && (0, import_jsx_runtime.jsx)(al, {
        style: {
          position: "fixed",
          left: 16,
          top: 16,
...
//# sourceMappingURL=Widgets-WSO6TDOD.js.map
