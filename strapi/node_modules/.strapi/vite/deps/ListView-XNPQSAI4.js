  ...
  return (0, import_jsx_runtime5.jsxs)(ComponentBox, {
    ...
    children: [
      ...
      isInDevelopmentMode && !disabled && (0, import_jsx_runtime5.jsx)(CloseButton, {
        ...
        tag: "button",
        onClick: onClose,
        children: (0, import_jsx_runtime5.jsx)(C5, {})
      })
    ]
  });
};
...
var DynamicZoneList = ({ components = [], addComponent, name, forTarget, targetUid, disabled = false }) => {
  ...
  return (0, import_jsx_runtime6.jsx)(ComponentRow, {
    ...
    children: (0, import_jsx_runtime6.jsxs)(R, {
      children: [
        ...
        (0, import_jsx_runtime6.jsx)(R, {
          children: components.map((component, index) => {
            return (0, import_jsx_runtime6.jsx)(R, {
        ...
        children: [
          (0, import_jsx_runtime7.jsxs)(T, {
            ...
            children: [
              ...
              isInDevelopmentMode && (0, import_jsx_runtime7.jsx)(st, {
                cursor,
                role: "Handle",
                ref: handleRef,
                ...listeners,
                ...
                children: (0, import_jsx_runtime7.jsx)(V5, {})
              }),
              (0, import_jsx_runtime7.jsxs)(T, {
                gap: 4,
                children: [
                  (0, import_jsx_runtime7.jsxs)(T, {
                    ...
                    children: [
                      ...
                      (0, import_jsx_runtime7.jsxs)(I, {
                        ...
                        children: [
                          item.name,
                          "required" in item && item.required && (0, import_jsx_runtime7.jsx)(I, {
                            textColor: "danger600",
                            children: "* "
                          })
                        ]
                  ...
                  (0, import_jsx_runtime7.jsx)(T, {
                    children: (0, import_jsx_runtime7.jsxs)(I, {
                      ...
                      children: [
                        ...
                        "conditions" in item && item.conditions && Object.keys(item.conditions).length > 0 && (0, import_jsx_runtime7.jsx)(Ls, {
                          margin: 4,
                        ...
                        item.type === "relation" && (0, import_jsx_runtime7.jsxs)(import_jsx_runtime7.Fragment, {
                          children: [
                            ...
                            " ",
                            targetContentType && (0, import_jsx_runtime7.jsx)(Vc, {
          ...
          (0, import_jsx_runtime7.jsx)(R, {
            children: (0, import_jsx_runtime7.jsx)(T, {
              ...
              children: (0, import_jsx_runtime7.jsxs)(import_jsx_runtime7.Fragment, {
                children: [
                  ...
                  [
                    "component",
                    "dynamiczone"
                  ].includes(item.type) && (0, import_jsx_runtime7.jsx)(st, {
                    onClick: (e) => {
                      e.preventDefault();
                      e.stopPropagation();
                      if (isOpen) {
                  ...
                  isInDevelopmentMode && item.configurable !== false ? (0, import_jsx_runtime7.jsxs)(import_jsx_runtime7.Fragment, {
                    children: [
                      !isMorph && (0, import_jsx_runtime7.jsx)(st, {
                        onClick: handleClick,
                        label: `${formatMessage({
                          id: "app.utils.edit",
                          defaultMessage: "Edit"
                        ...
                        variant: "ghost",
                        disabled: !canEdit,
                        children: (0, import_jsx_runtime7.jsx)(_3, {})
                      }),
                      (0, import_jsx_runtime7.jsx)(st, {
                        ...
                        variant: "ghost",
                        disabled: !canDelete,
                        children: (0, import_jsx_runtime7.jsx)(bn, {})
                      }),
                      (0, import_jsx_runtime7.jsx)(_m.Root, {
                    ...
                    padding: 2,
                    children: (0, import_jsx_runtime7.jsx)(B3, {
                      fill: "neutral500"
                    })
                  })
                ]
...
var List = ({ addComponentToDZ, firstLoopComponentUid, isFromDynamicZone = false, isMain = false, isSub = false, secondLoopComponentUid, type }) => {
  ...
  if ((type == null ? void 0 : type.attributes.length) === 0 && isMain) {
    return (0, import_jsx_runtime9.jsx)(Jm, {
      action: (0, import_jsx_runtime9.jsx)(tours.contentTypeBuilder.AddFields, {
      ...
      hasRadius: true,
      icon: (0, import_jsx_runtime9.jsx)(K, {
        width: "16rem"
      })
    });
  }
  return (0, import_jsx_runtime9.jsxs)(DndContext, {
    ...
    children: [
      ...
      isMain && isInDevelopmentMode && (0, import_jsx_runtime9.jsx)(TFooter, {
        ...
        icon: (0, import_jsx_runtime9.jsx)(sn, {}),
        onClick: onClickAddField,
...
var LinkToCMSettingsView = (0, import_react4.memo)(({ disabled, type }) => {
  ...
  return (0, import_jsx_runtime10.jsx)(StyledButton, {
    startIcon: (0, import_jsx_runtime10.jsx)(S3, {}),
    variant: "tertiary",
    onClick: handleClick,
    disabled,
    children: label
...
var ListView = () => {
  ...
  const primaryAction = isInDevelopmentMode && (0, import_jsx_runtime11.jsxs)(T, {
    gap: 2,
    children: [
      ...
      (0, import_jsx_runtime11.jsx)(zn, {
        startIcon: (0, import_jsx_runtime11.jsx)(_3, {}),
        variant: "tertiary",
        onClick: onEdit,
  ...
  return (0, import_jsx_runtime11.jsxs)(import_jsx_runtime11.Fragment, {
    children: [
      (0, import_jsx_runtime11.jsx)(tours.contentTypeBuilder.Introduction, {
        children: (0, import_jsx_runtime11.jsx)(R, {})
      }),
      isDeleted && (0, import_jsx_runtime11.jsx)(T, {
...
//# sourceMappingURL=ListView-XNPQSAI4.js.map
