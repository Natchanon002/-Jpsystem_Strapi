    ...
    <div className="bg-white min-h-screen font-sans flex flex-col">
        ...
        <Container>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Reveal>
              <div className="h-full rounded-[2rem] bg-sky-50 p-8 shadow-sm border border-sky-100">
                <div className="flex items-start justify-between mb-6">
                  <h3 className="text-xl font-bold text-slate-800">{p.definitionEtaxTitle}</h3>
            ...
            <Reveal delay={0.1}>
              <div className="h-full rounded-[2rem] bg-sky-50 p-8 shadow-sm border border-sky-100">
                <div className="flex items-start justify-between mb-6">
                  <h3 className="text-xl font-bold text-slate-800">{p.definitionSigTitle}</h3>
      ...
      <section className="py-12 bg-white">
        <Container>
          <div className="text-center mb-10">
            <Reveal>
              <h2 className="text-xl font-semibold text-slate-600">{p.benefitsTitle}</h2>
                ...
                <Reveal key={idx} delay={idx * 0.05}>
                  <div className="bg-white rounded-[2rem] p-6 shadow-md h-full flex flex-col border border-slate-100">
                    <div className="flex justify-between items-center mb-4">
                      ...
                      <Image src={`/benefit_${idx + 1}.png`} width={30} height={30} alt="icon" className="object-contain" />
                    </div>
      ...
      <section className="py-20 bg-white">
        <Container>
          <div className="text-center mb-12">
            <Reveal>
              <h2 className="text-2xl font-bold text-slate-800 tracking-tight">{p.mechanismTitle}</h2>
      ...
      <section className="py-16 bg-white flex-grow">
        <Container>
          <div className="text-center mb-12">
            <Reveal>
              <h2 className="text-2xl font-semibold text-slate-700">{p.costTitle}</h2>
              <div className="mt-4 mx-auto h-px w-56 bg-slate-400" />
            </Reveal>
          </div>
          ...
          <Reveal>
            <div className="mx-auto max-w-3xl rounded-[2.5rem] border border-slate-200 bg-white p-8 md:p-12 shadow-lg">
              <h3 className="text-center text-slate-600 font-bold mb-10 text-lg">{p.costSubtitle}</h3>
              <div className="space-y-6 max-w-md mx-auto">
                ...
                <div className="flex justify-between items-center text-slate-800 pt-4">
                  <span className="text-xl font-black uppercase">{p.costTotal}</span>
                  <span className="text-xl font-black">{p.costTotalValue}</span>
                </div>
              </div>
