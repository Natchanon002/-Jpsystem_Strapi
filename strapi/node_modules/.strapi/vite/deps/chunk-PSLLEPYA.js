...
var ModalForm = ({ onToggle }) => {
  ...
  const roleLayout = useEnterprise(ROLE_LAYOUT, async () => (await import("./ModalForm-MKKLGD4O.js")).ROLE_LAYOUT, {
  ...
  const initialValues = useEnterprise(FORM_INITIAL_VALUES, async () => (await import("./ModalForm-MKKLGD4O.js")).FORM_INITIAL_VALUES, {
  ...
  const MagicLink = useEnterprise(MagicLinkCE, async () => (await import("./MagicLinkEE-YVSRV7XB.js")).MagicLinkEE);
    ...
    children: (0, import_jsx_runtime2.jsxs)(n1.Content, {
      children: [
        (0, import_jsx_runtime2.jsx)(n1.Header, {
          children: (0, import_jsx_runtime2.jsx)(Tc, {
            label: headerTitle,
            children: (0, import_jsx_runtime2.jsx)(Rc, {
              isCurrent: true,
              ...
              children: [
                    ...
                    children: [
                      ...
                      (0, import_jsx_runtime2.jsxs)(R, {
                        children: [
                          ...
                          (0, import_jsx_runtime2.jsx)(R, {
                            paddingTop: 4,
                            children: (0, import_jsx_runtime2.jsxs)(Um.Root, {
                              gap: 5,
                              children: [
                ...
                (0, import_jsx_runtime2.jsxs)(n1.Footer, {
                  children: [
                    ...
                    currentStep === "create" ? (0, import_jsx_runtime2.jsx)(zn, {
                      type: "submit",
...
var ListPageCE = () => {
  ...
  const CreateAction = useEnterprise(CreateActionCE, async () => (await import("./CreateActionEE-YTIOOB2S.js")).CreateActionEE);
  ...
  return (0, import_jsx_runtime3.jsxs)(Page.Main, {
    ...
    children: [
                      ...
                      children: [
                        ...
                        canRead || canDelete ? (0, import_jsx_runtime3.jsx)(Table.Cell, {
                          ...
                          children: (0, import_jsx_runtime3.jsxs)(T, {
                            justifyContent: "end",
                            children: [
                              canRead ? (0, import_jsx_runtime3.jsx)(st, {
                                tag: NavLink,
                                to: user.id.toString(),
                                label: formatMessage({
                              ...
                              canDelete && (currentUser == null ? void 0 : currentUser.id) !== user.id ? (0, import_jsx_runtime3.jsx)(st, {
                                ...
                                variant: "ghost",
                                children: (0, import_jsx_runtime3.jsx)(bn, {})
                              }) : null
                            ]
                          })
                        }) : null
      ...
      (0, import_jsx_runtime3.jsx)(_m.Root, {
...
var TABLE_HEADERS = [
  ...
  },
  {
    ...
    sortable: false,
    cellFormatter({ roles }) {
      return (0, import_jsx_runtime3.jsx)(I, {
        textColor: "neutral800",
  ...
  },
  {
    ...
    cellFormatter({ isActive }) {
      return (0, import_jsx_runtime3.jsx)(T, {
        children: (0, import_jsx_runtime3.jsx)(g1, {
          size: "S",
...
var ListPage = () => {
  const UsersListPage = useEnterprise(ListPageCE, async () => (
    ...
    (await import("./ListPage-KO5FZRK5.js")).UserListPageEE
  ));
  if (!UsersListPage) {
    return null;
  }
...
//# sourceMappingURL=chunk-PSLLEPYA.js.map
