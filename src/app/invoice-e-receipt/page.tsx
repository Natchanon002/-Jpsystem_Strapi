          ...
          <div className="relative py-16 sm:py-20 lg:py-24">
            ...
            <Reveal delay={0.16}>
              <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:items-center">
                ...
                <Link
                  href="/e-tax"
                  className="inline-flex items-center justify-center rounded-full border border-slate-200 bg-white/70 px-5 py-3 text-sm font-semibold text-slate-800 backdrop-blur transition-colors hover:border-slate-300 hover:bg-white/90"
                  data-cursor="interactive"
                >
                  {p.cta.secondary}
                </Link>
