...
var ListPage = () => {
  ...
  return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
    children: [
      ...
      (0, import_jsx_runtime.jsxs)(Page.Main, {
        ...
        children: [
          (0, import_jsx_runtime.jsx)(Layouts.Header, {
            ...
            primaryAction: canCreate && !isLoading && (0, import_jsx_runtime.jsx)(e1, {
              tag: NavLink,
            ...
            startActions: (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
              children: [
                ...
                (0, import_jsx_runtime.jsx)(zn, {
                  ...
                  startIcon: (0, import_jsx_runtime.jsx)(bn, {}),
                  size: "L",
          ...
          (0, import_jsx_runtime.jsx)(Layouts.Content, {
            children: numberOfWebhooks > 0 ? (0, import_jsx_runtime.jsxs)(C1, {
              colCount: 5,
              rowCount: numberOfWebhooks + 1,
              footer: (0, import_jsx_runtime.jsx)(M1, {
                onClick: () => {
                  if (canCreate) {
                    navigate("create");
                  }
                },
                icon: (0, import_jsx_runtime.jsx)(sn, {}),
                children: formatMessage({
                  id: "Settings.webhooks.list.button.add",
                  defaultMessage: "Create new webhook"
                })
              ...
              children: [
                (0, import_jsx_runtime.jsx)($1, {
                  children: (0, import_jsx_runtime.jsxs)(A1, {
                    children: [
                      (0, import_jsx_runtime.jsx)(T1, {
                ...
                (0, import_jsx_runtime.jsx)(k1, {
                  children: webhooks == null ? void 0 : webhooks.map((webhook) => (0, import_jsx_runtime.jsxs)(A1, {
                    onClick: () => {
                      if (canUpdate) {
                        navigate(webhook.id);
                      }
                    ...
                    children: [
                      ...
                      (0, import_jsx_runtime.jsx)(R1, {
                        ...
                        children: (0, import_jsx_runtime.jsx)(T, {
                          children: (0, import_jsx_runtime.jsx)(v1, {
                      ...
                      (0, import_jsx_runtime.jsx)(R1, {
                        children: (0, import_jsx_runtime.jsxs)(T, {
                          gap: 1,
                          children: [
                            canUpdate && (0, import_jsx_runtime.jsx)(st, {
                              label: formatMessage({
            ...
            }) : (0, import_jsx_runtime.jsx)(Jm, {
              icon: (0, import_jsx_runtime.jsx)(K, {
                width: "160px"
              }),
              ...
              action: canCreate ? (0, import_jsx_runtime.jsx)(e1, {
                variant: "secondary",
                startIcon: (0, import_jsx_runtime.jsx)(sn, {}),
                tag: NavLink,
                to: "create",
      ...
      (0, import_jsx_runtime.jsx)(_m.Root, {
        open: showModal,
...
//# sourceMappingURL=ListPage-GKKVN2JU.js.map
