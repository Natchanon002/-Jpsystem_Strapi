...
var storeToken = (token) => {
  ...
  if (wasPersistedToLocalStorage) {
    ...
    setCookie(STORAGE_KEYS2.TOKEN, token);
  }
  if (onTokenUpdate) {
    onTokenUpdate(token);
  }
...
var coreModule = function() {
  return {
    ...
    init: function(api, _j, context) {
      ...
      safeAssign(api, { reducer: reducer2, middleware });
...
//# sourceMappingURL=chunk-HD7BKYOR.js.map
