import {
  CardDragPreview
} from "./chunk-OPCRQD4C.js";
import {
  FieldTypeIcon
} from "./chunk-RHJOST4Q.js";
import {
  useTypedSelector
...
var Settings = () => {
  ...
  return (0, import_jsx_runtime2.jsxs)(T, {
    ...
    children: [
      ...
      (0, import_jsx_runtime2.jsx)(Um.Root, {
        gap: 4,
        children: formLayout.map((row) => row.map(({ size, ...field }) => (0, import_jsx_runtime2.jsx)(Um.Item, {
          xs: 12,
          col: size,
          direction: "column",
          alignItems: "stretch",
...
var EditFieldForm = ({ attribute, name, onClose }) => {
  ...
  return (0, import_jsx_runtime3.jsx)(n1.Content, {
    children: (0, import_jsx_runtime3.jsxs)(Form, {
      ...
      children: [
        (0, import_jsx_runtime3.jsx)(n1.Header, {
          children: (0, import_jsx_runtime3.jsxs)(HeaderContainer, {
            children: [
              ...
              (0, import_jsx_runtime3.jsx)(n1.Title, {
                children: formatMessage({
        ...
        (0, import_jsx_runtime3.jsx)(n1.Body, {
          children: (0, import_jsx_runtime3.jsx)(Um.Root, {
            gap: 4,
            children: [
              {
                name: "label",
            ...
            ].filter((field) => field.name !== "sortable" || field.name === "sortable" && shouldDisplaySortToggle).map(({ size, ...field }) => (0, import_jsx_runtime3.jsx)(Um.Item, {
              xs: 12,
              col: size,
              direction: "column",
              alignItems: "stretch",
...
var DraggableCard = ({ attribute, index, isDraggingSibling, label, name, onMoveField, onRemoveField, setIsDraggingSibling }) => {
  ...
  const composedRefs = Ce(dropRef, objectRef);
      ...
      !isDragging && !isDraggingSibling && (0, import_jsx_runtime4.jsxs)(FieldContainer, {
        ...
        children: [
          (0, import_jsx_runtime4.jsxs)(T, {
            ...
            children: [
              (0, import_jsx_runtime4.jsx)(DragButton, {
                ...
                type: "button",
                children: (0, import_jsx_runtime4.jsx)(V5, {})
              }),
          ...
          (0, import_jsx_runtime4.jsxs)(T, {
            ...
            onClick: (e) => e.stopPropagation(),
            children: [
              (0, import_jsx_runtime4.jsxs)(n1.Root, {
                open: isModalOpen,
                onOpenChange: setIsModalOpen,
                children: [
                  (0, import_jsx_runtime4.jsx)(n1.Trigger, {
                    children: (0, import_jsx_runtime4.jsx)(ActionButton, {
                      ...
                      type: "button",
                      children: (0, import_jsx_runtime4.jsx)(_3, {
                        width: "1.2rem",
                        height: "1.2rem"
                      })
                    })
              ...
              (0, import_jsx_runtime4.jsx)(ActionButton, {
                ...
                type: "button",
                children: (0, import_jsx_runtime4.jsx)(C5, {
                  width: "1.2rem",
                  height: "1.2rem"
                })
              })
...
`;
var DragButton = gt(ActionButton)`
  padding: 0 ${({ theme }) => theme.spaces[3]};
  border-right: 1px solid ${({ theme }) => theme.colors.neutral150};
  cursor: all-scroll;
`;
var FieldContainer = gt(T)`
  max-height: 3.2rem;
  cursor: pointer;
`;
var FieldWrapper = gt(R)`
  &:last-child {
    ...
    children: [
      ...
      (0, import_jsx_runtime5.jsxs)(T, {
        ...
        children: [
          ...
          (0, import_jsx_runtime5.jsxs)(Am.Root, {
            children: [
              (0, import_jsx_runtime5.jsxs)(Am.Trigger, {
                paddingLeft: 2,
                paddingRight: 2,
              ...
              (0, import_jsx_runtime5.jsx)(Am.Content, {
                children: nonDisplayedFields.map((field) => (0, import_jsx_runtime5.jsx)(Am.Item, {
...
var ListConfiguration = () => {
  ...
  const initialValues = React4.useMemo(() => {
    ...
    const headerMetadatas = headerNames.reduce((acc, name) => {
      var _a;
      acc[name] = ((_a = metadata[name]) == null ? void 0 : _a.list) ?? list.metadatas[name] ?? {
        label: name
      };
      return acc;
    }, {});
    const listFieldLayouts = listViewConversionContext ? convertListLayoutToFieldLayouts(headerNames, schema == null ? void 0 : schema.attributes, headerMetadatas, {
      configurations: listViewConversionContext.componentConfigurations,
      schemas: listViewConversionContext.componentSchemas
    }, listViewConversionContext.contentTypeSchemas) : convertListLayoutToFieldLayouts(headerNames, schema == null ? void 0 : schema.attributes, headerMetadatas);
    return {
...
var ProtectedListConfiguration = () => {
  ...
  return (0, import_jsx_runtime6.jsx)(Page.Protect, {
    permissions,
    children: (0, import_jsx_runtime6.jsx)(ListConfiguration, {}, slug)
  });
};
export {
  ListConfiguration,
...
//# sourceMappingURL=ListConfigurationPage-LT6LEDTS.js.map
