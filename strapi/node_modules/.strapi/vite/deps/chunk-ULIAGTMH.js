...
var getStageColorByHex = (hex) => {
  ...
  const themeColors = Object.entries(el.colors).filter(([, value]) => value.toUpperCase() === hex.toUpperCase());
...
var AVAILABLE_COLORS = Object.entries(STAGE_COLORS).map(([themeColorName, name]) => ({
  hex: el.colors[themeColorName].toUpperCase(),
  name
}));
...
//# sourceMappingURL=chunk-ULIAGTMH.js.map
