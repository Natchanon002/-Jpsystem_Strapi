...
// node_modules/@strapi/admin/dist/admin/admin/src/features/Notifications.mjs
var NotificationsContext = React2.createContext({
  toggleNotification: () => {
  }
});
var NotificationsProvider = ({ children }) => {
  const toggleNotification = React2.useCallback(({ type, message, link, timeout, blockTransition, onClose, title }) => {
    toast.custom((id) => {
...
var Notification = ({ clearNotification, link, message, onClose, title, type }) => {
  ...
  return (0, import_jsx_runtime.jsx)(Cm, {
    action: link ? (0, import_jsx_runtime.jsx)(Vc, {
      href: link.url,
      isExternal: true,
      children: link.label
    }) : void 0,
...
var useNotification = () => React2.useContext(NotificationsContext);
...
@strapi/admin/dist/admin/admin/src/features/Notifications.mjs:
  ...
  *)
*/
//# sourceMappingURL=chunk-5ITB6TES.js.map
