    ...
    children: (0, import_jsx_runtime.jsxs)(LogoInputContextProvider, {
      ...
      children: [
        (0, import_jsx_runtime.jsx)(Hm, {
          ...
          actions: (0, import_jsx_runtime.jsxs)(jm, {
            children: [
              ...
              (customLogo == null ? void 0 : customLogo.url) && (0, import_jsx_runtime.jsx)(st, {
                disabled: !canUpdate,
                ...
                children: (0, import_jsx_runtime.jsx)(T2, {})
              })
            ]
          }),
          children: (0, import_jsx_runtime.jsx)(Km, {
            label: formatMessage({
        ...
        (0, import_jsx_runtime.jsxs)(n1.Content, {
          children: [
...
var AddLogoDialog = () => {
  const { formatMessage } = useIntl();
  return (0, import_jsx_runtime.jsxs)(S1.Root, {
    variant: "simple",
    ...
    children: [
      (0, import_jsx_runtime.jsx)(R, {
        paddingLeft: 8,
        paddingRight: 8,
        children: (0, import_jsx_runtime.jsxs)(S1.List, {
...
var URLForm = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const mimeType = typeof contentType === "string" ? contentType : Array.isArray(contentType) ? contentType[0] : contentType != null && typeof contentType !== "object" ? String(contentType) : void 0;
      const file = new File([
        res.data
      ], res.config.url ?? "", {
        type: mimeType
...
var ComputerForm = () => {
  ...
  return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
    children: [
      ...
      (0, import_jsx_runtime.jsx)(n1.Footer, {
...
var ImageCardAsset = ({ asset }) => {
  var _a;
  const { formatMessage } = useIntl();
  return (0, import_jsx_runtime.jsxs)(Rm, {
    children: [
      (0, import_jsx_runtime.jsx)(Pm, {
        children: (0, import_jsx_runtime.jsx)(Mm, {
          size: "S",
          src: asset.url
        })
      }),
      (0, import_jsx_runtime.jsxs)(Om, {
        children: [
          (0, import_jsx_runtime.jsxs)(Im, {
            children: [
              (0, import_jsx_runtime.jsx)(Bm, {
                children: asset.name
              }),
              (0, import_jsx_runtime.jsx)(zm, {
...
var ApplicationInfoPage = () => {
  ...
  const AdminSeatInfo = useEnterprise(AdminSeatInfoCE, async () => (await import("./AdminSeatInfo-RK5BWM7K.js")).AdminSeatInfoEE);
  const isAiEnabled = ((_a = window.strapi.ai) == null ? void 0 : _a.enabled) !== false;
  const AIUsageData = useEnterprise(AIUageDataCE, async () => (await import("./AIUsage-63UO526M.js")).AIUsage, {
    enabled: isAiEnabled
  });
        ...
        children: (0, import_jsx_runtime2.jsxs)("form", {
          ...
          children: [
            (0, import_jsx_runtime2.jsx)(Layouts.Header, {
              ...
              primaryAction: canUpdate && (0, import_jsx_runtime2.jsx)(zn, {
                disabled: isSaveDisabled,
                type: "submit",
                startIcon: (0, import_jsx_runtime2.jsx)(t5, {}),
                fullWidth: true,
                children: formatMessage({
                  id: "global.save",
                  defaultMessage: "Save"
                ...
                children: [
                  (0, import_jsx_runtime2.jsxs)(T, {
                    ...
                    children: [
                      ...
                      (0, import_jsx_runtime2.jsxs)(Um.Root, {
                        gap: 5,
                        tag: "dl",
                        children: [
                          (0, import_jsx_runtime2.jsxs)(Um.Item, {
                            col: 6,
                            xs: 12,
                            direction: "column",
                            alignItems: "start",
                            children: [
                              ...
                              (0, import_jsx_runtime2.jsxs)(T, {
                                ...
                                children: [
                                  ...
                                  shouldUpdateStrapi && (0, import_jsx_runtime2.jsx)(Vc, {
                                    href: `https://github.com/strapi/strapi/releases/tag/${latestStrapiReleaseTag}`,
                                    endIcon: (0, import_jsx_runtime2.jsx)(f5, {}),
                                    children: formatMessage({
                          ...
                          (0, import_jsx_runtime2.jsx)(AIUsageData, {})
                        ]
                      })
                    ]
                  }),
                  canRead && (0, import_jsx_runtime2.jsxs)(R, {
                    hasRadius: true,
                    background: "neutral0",
                    shadow: "tableShadow",
                    paddingTop: 6,
                    ...
                    children: [
                      ...
                      (0, import_jsx_runtime2.jsxs)(Um.Root, {
                        ...
                        gap: 4,
                        children: [
                          (0, import_jsx_runtime2.jsx)(Um.Item, {
                            col: 6,
                            xs: 12,
                            direction: "column",
                            alignItems: "stretch",
...
//# sourceMappingURL=ApplicationInfoPage-RQRATV3R.js.map
